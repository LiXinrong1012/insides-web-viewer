...
{
public:
	Render3DTreeItemProperties(RenderWidget* w=NULL):_OSGWidget(w){}

	RenderWidget* _OSGWidget;
...
class PREVOSG_EXPORT RenderView : public Base::View
{
public:
	RenderView(void);
	~RenderView(void);
