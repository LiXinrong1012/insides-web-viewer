...
class BASE_EXPORT ViewLayoutManager
{
public:
	ViewLayoutManager(void);
	~ViewLayoutManager(void);
	...
	bool AssignView(int location, View* view);
	...
	int AssignViewToAnyCell(View* view, int location_hint);
	...
	void SaveAllState(const QString& fileName);
	void LoadAllState(const QString& fileName);
