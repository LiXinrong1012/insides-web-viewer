#include "SegmentBrowserDialog.h"
...
//icons
//#include "../preui/resources/hoops/fileopen.xpm"
//#include "../preui/resources/hoops/fileclosed.xpm"
//#include "../preui/resources/hoops/attributeicon.xpm"
//#include "../preui/resources/hoops/geomicon.xpm"


HQSegmentBrowserFrame::HQSegmentBrowserFrame(QWidget *p):QDialog(p)
{
...
void segTreeEditBox::ok_clicked(){
	...
	// de-select
	HSelectionSet *selection= (HSelectionSet *)m_pHoopsView->GetSelection();
	if(selection)
...
void segTreeListView::item_expanded(QTreeWidgetItem * i)
{
	...
	QPixmap *segmentOpenIcon= new QPixmap(":/resources/hoops/fileopen.xpm");
...
void segTreeListView::item_collapsed(QTreeWidgetItem * i)
{
	...
	QPixmap *segmentClosedIcon= new QPixmap(":/resources/hoops/fileclosed.xpm" );
...
void segTreeListViewItem::addAttributeLeaves(HC_KEY segKey, segTreeListViewItem *item)
{
	...
	while (HC_Find_Contents(type, &tempKey))
	{
		...
		QPixmap *segmentAttributeIcon= new QPixmap(":/resources/hoops/attributeicon.xpm");
...
void segTreeListViewItem::addGeometryCountLeaves(HC_KEY segKey, segTreeListViewItem *item)
{
	...
	if (TotalSegments > 0)
	{
		...
		QPixmap *segmentGeomIcon= new QPixmap(":/resources/hoops/geomicon.xpm" );
