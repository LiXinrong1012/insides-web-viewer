...
#define FLEXLM_COPYRIGHT_YEAR "2009"
...
#if (_MSC_VER >= 1400 ) && !(defined(_LP64) || defined(_WIN64)) /* only if 32bit and VC2005 or above */ 
#ifndef _USE_32BIT_TIME_T 
        //#error "Incompatible size of time_t detected, on 32 bit platforms time_t must be 32 bits in length. See _USE_32BIT_TIME_T."
#endif 
#endif				
