/***************************************************************
	    Copyright (c) 2005-2009 Flexera Software, Inc. All Rights Reserved.
...
#define LM_TS_NO_PRODUCT_SET			(LM_TS_BASE_ERROR+48)
#define LM_TS_TRIALPACKS_ASR_ENTRY		(LM_TS_BASE_ERROR+49)


/* 
* Errors in this range are returned only by Composite Transaction functions ( flxActTranXXX() )
* and are defined in FlxActTransaction.h
*/
#define LM_TS_CT_BASE					(LM_TS_BASE_ERROR+1000)
#define LM_TS_CT_LAST					(LM_TS_BASE_ERROR+1999)
