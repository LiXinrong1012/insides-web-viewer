...
// manner of such use.
//
// $Header: /files/homes/master/cvs/hoops_master/3dsmax/source/HUtilityTextParser.h,v 1.3 2007-08-30 20:00:38 stage Exp $
//
...
private:
	...
	bool MultiCompare(char *text, char *ctext);
	static unsigned long FindNextChar(char *text, char c, unsigned long start);
