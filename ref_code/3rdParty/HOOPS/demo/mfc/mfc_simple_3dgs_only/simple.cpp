...
// manner of such use.
//
// $Header: /files/homes/master/cvs/hoops_master/mfc_simple/simple.cpp,v 1.4 2006-08-07 20:38:55 stage Exp $
//
...
void CSimpleApp::OnFileOpen() 
{
	CString filter;
	CString def_ext;

   	filter = "HOOPS Metafile (*.hmf)|*.hmf||";
	def_ext = ".hmf";
