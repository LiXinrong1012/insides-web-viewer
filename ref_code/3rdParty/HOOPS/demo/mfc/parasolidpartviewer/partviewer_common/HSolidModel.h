...
#endif // ACIS
#ifdef GRANITE
	KComponentList_ptr m_componentList; // the granite objects (assembly/body/model) from this file
#endif // GRANITE
#ifdef INTEROP
...
#ifdef GRANITE
	void DeleteGraniteEntity( KObj_ptr entity);
	void AddGraniteEntity( KObj_ptr entity);
	void RemoveGraniteEntity( KObj_ptr entity);
	KComponentList_ptr GetComponentList() { return m_componentList; }
//	KObj_ptr Compute_Selected_Instance();
#endif // GRANITE
...
#ifdef PARASOLID
	void	WriteEntity(HUtilityXMLGenerator *xmlgen, PK_ENTITY_t entity); 
	int	GetTagID(PK_ENTITY_t entity, char *type);
#endif // PARASOLID
#ifdef GRANITE
	void	WriteEntity(HUtilityXMLGenerator *xmlgen, KERN_ENTITY entity); 
	int	GetTagID(KERN_ENTITY entity);
#endif // GRANITE
