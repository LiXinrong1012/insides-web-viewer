...
public:
 ...
 // Dialog Data
#ifdef PARASOLID
	enum { IDD = IDD_TOPOLBROWSER };
#endif // PARASOLID
#ifdef ACIS
	enum { IDD = IDD_TOPOLBROWSER1 };
#endif // ACIS
#ifdef GRANITE
	enum { IDD = IDD_TOPOLBROWSER2 };
#endif // GRANITE
...
protected:
	...
	virtual HTREEITEM InsertItemInTree(PK_ENTITY_t entity,const char* basetext,HTREEITEM position){ assert(0); return 0;}
	virtual void UpdateInfoWindow(PK_ENTITY_t entity){ assert(0); }
	virtual void  FillItems(PK_ENTITY_t entity,HTREEITEM item){ assert(0); }
...
#ifdef GRANITE
	virtual HTREEITEM InsertItemInTree(KERN_ENTITY entity, char* basetext, HTREEITEM position){ assert(0); return 0;}
	virtual void UpdateInfoWindow(KERN_ENTITY entity){ assert(0); }
	virtual void  FillItems(KERN_ENTITY entity,HTREEITEM item){ assert(0); }
	virtual bool  CheckSelection(KERN_ENTITY entity){ assert(0); return false; }
#endif // GRANITE
