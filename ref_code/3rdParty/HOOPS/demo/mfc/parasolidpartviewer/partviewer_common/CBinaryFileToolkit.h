...
class  TK_PSUser_Data : public TK_User_Data {
...
#ifdef PARASOLID
		PK_PARTITION_t	m_partition;		/*!< Parasolid partition containing the entities */
    ...
    public:
		...
		\param PK_PARTITION_t Parasolid partition to export/receive Parasolid entities
		\param psf Is the solid modeler file embedded
		*/
        TK_PSUser_Data (CModellerInfo **mi, PK_PARTITION_t = 0, bool psf = false);
#endif //PARASOLID
...
#ifdef GRANITE
		KComponentList_ptr m_componentList;	/*!< List of Granite entities to be embedded as a .prt file */

    public:
		/*!
		Constructor
		\param mi Solid modeler information
		\param componentList Granite components list to export/receive
		\param psf Is the solid modeler file embedded
		*/
        TK_PSUser_Data (CModellerInfo **mi, KComponentList_ptr componentList, bool psf = false);
#endif // GRANITE
