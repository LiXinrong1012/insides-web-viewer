...
#ifdef PARASOLID
	static CString SchemaPath;		// Parasolid schema directory path to enable reading of x_t files
	static CString DefaultSchemaPath;		// default value
	static CString SchemaPathEntry;	// registry location

	static bool	bFlattenAssemblies;			// if to break down assemblies into flat structure
	static bool	DefaultbFlattenAssemblies;			// default value
	static CString	FlattenAssembliesEntry;	// registry location

	static bool	bBinaryX_TFiles;		// if to read/write binary x_t files
	static bool	DefaultbBinaryX_TFiles;	// default value
	static CString BinaryX_TFilesEntry;	// registry location
#endif // PARASOLID

	
	//-- Tessellation Settings 
#ifdef PARASOLID
	static PK_LOGICAL_t IsCurveChordTol;				// do we have curve chord tolerance
	static PK_LOGICAL_t DefaultIsCurveChordTol;			// default value
	static CString IsCurveChordTolEntry;		// registry location

	static PK_LOGICAL_t IsCurveChordAngTol;				// do we have curve angular tolerance
	static PK_LOGICAL_t DefaultIsCurveChordAngTol;		// default value
	static CString IsCurveChordAngTolEntry;		// registry location;

	static PK_LOGICAL_t IsFacetPlaneTol;				// do we have facet plane tolerance
	static PK_LOGICAL_t DefaultIsFacetPlaneTol;			// default value
	static CString IsFacetPlaneTolEntry;		// registry location


	static PK_LOGICAL_t IsFacetPlaneAngTol;				// do we have face place tolerance
	static PK_LOGICAL_t DefaultIsFacetPlaneAngTol;		// default value
	static CString IsFacetPlaneAngTolEntry;		// registry location

	static PK_LOGICAL_t IsSurfacePlaneTol;				// do we have surface plane tolerance
	static PK_LOGICAL_t DefaultIsSurfacePlaneTol;		// default value
	static CString IsSurfacePlaneTolEntry;		// registry location


	static PK_LOGICAL_t IsSurfacePlaneAngTol;			// do we have surface plane ang. tolerance
	static PK_LOGICAL_t DefaultIsSurfacePlaneAngTol;	// default value
	static CString IsSurfacePlaneAngTolEntry;	// registry location


	static PK_LOGICAL_t IsLineCurveChordTol;				// do we have line curve chord tolerance
	static PK_LOGICAL_t DefaultIsLineCurveChordTol;			// default value
	static CString IsLineCurveChordTolEntry;		// registry location

	static PK_LOGICAL_t IsLineCurveChordAngTol;				// do we have line curve chord angular tolerance
	static PK_LOGICAL_t DefaultIsLineCurveChordAngTol;		// default value
	static CString IsLineCurveChordAngTolEntry;		// registry location;


	static CString CurveChordTol;				//  curve chord tolerance
	static CString DefaultCurveChordTol;		// default value
	static CString CurveChordTolEntry;			// regtry location

	static CString CurveChordAngTol;			//  curve angular tolerance
	static CString DefaultCurveChordAngTol;		// default value
	static CString CurveChordAngTolEntry;		// regtry location;

	static CString FacetPlaneTol;				//  facet plane tolerance
	static CString DefaultFacetPlaneTol;		// default value
	static CString FacetPlaneTolEntry;			// regtry location


	static CString FacetPlaneAngTol;			//  face place tolerance
	static CString DefaultFacetPlaneAngTol;		// default value
	static CString FacetPlaneAngTolEntry;		// regtry location

	static CString SurfacePlaneTol;				//  surface plane tolerance
	static CString DefaultSurfacePlaneTol;		// default value
	static CString SurfacePlaneTolEntry;		// regtry location

	static CString SurfacePlaneAngTol;			//  surface plane ang. tolerance
	static CString DefaultSurfacePlaneAngTol;	// default value
	static CString SurfacePlaneAngTolEntry;		// regtry location


	static CString LineCurveChordTol;			//  line curve chord tolerance
	static CString DefaultLineCurveChordTol;	// default value
	static CString LineCurveChordTolEntry;		// regtry location

	static CString LineCurveChordAngTol;		//  line curve chord angular tolerance
	static CString DefaultLineCurveChordAngTol;	// default value
	static CString LineCurveChordAngTolEntry;	// regtry location;


	static PK_facet_match_t FacetMatch;			//  Facet Matching
	static PK_facet_match_t DefaultFacetMatch;	// default value
	static CString	FacetMatchEntry;			// regtry location


#endif // PARASOLID

#ifdef GRANITE
	static CString AngularTolerance;		// KTriangulator.AngularTolerance
	static CString DefaultAngularTolerance;	// default value
	static CString AngularToleranceEntry;	// registry location

	static CString PlanarTolerance;			// KTriangulator.PlanarTolerance
	static CString DefaultPlanarTolerance;	// default value
	static CString PlanarToleranceEntry;	// registry location

	static CString TessellationTolerance;			// KTriangulator.TessellationTolerance
	static CString DefaultTessellationTolerance;	// default value
	static CString TessellationToleranceEntry;		// registry location
#endif // GRANITE
