...
#ifdef PARASOLID
	virtual void Select(PK_ENTITY_t entity, bool emit_message = true){ assert(0); }
	virtual	void DeSelectEntity(PK_ENTITY_t entity, bool emit_message = true){ assert(0); }
#endif // PARASOLID
...
#ifdef GRANITE
	virtual void Select(KObj_ptr entity, bool emit_message = true){ assert(0); }
	virtual	void DeSelectEntity(KObj_ptr entity, bool emit_message = true){ assert(0); }
#endif // GRANITE
