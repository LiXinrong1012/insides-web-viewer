...
// manner of such use.
//
// $Header: /files/homes/master/cvs/hoops_master/qthoopsrefapp_4/HMySelectionSet.h,v 1.6 2006-08-07 20:38:58 stage Exp $
//
...
public:
	...
	HMySelectionSet(HBaseView* view);
	...
	void Select(HC_KEY key, const char* segpath, HC_KEY include_key, HC_KEY includer_key, bool emit_message = false);
	void DeSelect(HC_KEY key, bool emit_message = false);


	void SetSelectLevel(SelectLevel level) { m_SelectLevel = level; }
	SelectLevel GetSelectLevel() { return (m_SelectLevel);}
