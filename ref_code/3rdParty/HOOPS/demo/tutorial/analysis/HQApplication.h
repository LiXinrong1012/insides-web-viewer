...
protected: 
	...
	static QPixmap * mapDataIcon ;
	static QPixmap * isolinesIcon ;
	static QPixmap * colorInterpIcon ;
	static QPixmap * quadInterpIcon ;
	...
	QAction * mapDataAct ;
	QAction * isolinesAct ;
	QAction * colorInterpAct ;
	QAction * quadInterpAct ;
	QAction * animateAct ;
}; 
