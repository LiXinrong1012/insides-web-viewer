...
// manner of such use.
//
// $Header: /files/homes/master/cvs/hoops_master/hoops_mvo/source/HOpCameraOrbit.cpp,v 1.88 2009-03-23 19:47:26 heppe Exp $
//
...
{
	return (HBaseOperator *)new HOpCameraOrbit(GetView());
}
