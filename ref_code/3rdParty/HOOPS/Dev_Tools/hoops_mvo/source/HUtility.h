...
// manner of such use.
//
// $Header: /files/homes/master/cvs/hoops_master/hoops_mvo/source/HUtility.h,v 1.257 2010-10-12 00:39:33 warren Exp $
//
...
public:
	...
	*/
	void AddPoints(HPoint *points, int pnum, HPoint *param = 0,  HPoint *normals = 0, bool AddImmediatly= false);
	...
	*/
	void AddFace(int *face, int fnum, int regionnum, HPoint *points, HPoint *normals = 0, bool AddImediatly= false);
