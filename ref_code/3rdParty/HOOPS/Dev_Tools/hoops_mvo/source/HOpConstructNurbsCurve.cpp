...
// manner of such use.
//
// $Header: /files/homes/master/cvs/hoops_master/hoops_mvo/source/HOpConstructNurbsCurve.cpp,v 1.5 2007-06-04 18:33:13 reuben Exp $
//
...
{
	return (HBaseOperator *)new HOpConstructNurbsCurve(GetView());
}//end Clone
