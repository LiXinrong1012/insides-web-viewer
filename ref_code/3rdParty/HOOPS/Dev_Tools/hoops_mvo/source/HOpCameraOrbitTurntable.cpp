...
// manner of such use.
//
// $Header: /files/homes/master/cvs/hoops_master/hoops_mvo/source/HOpCameraOrbitTurntable.cpp,v 1.3 2008-09-03 00:57:27 conor Exp $
//
...
{
	return (HBaseOperator *)new HOpCameraOrbitTurntable(GetView());
}
