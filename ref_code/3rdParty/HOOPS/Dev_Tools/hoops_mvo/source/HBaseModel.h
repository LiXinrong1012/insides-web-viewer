...
// manner of such use.
//
// $Header: /files/homes/master/cvs/hoops_master/hoops_mvo/source/HBaseModel.h,v 1.124 2010-06-17 19:46:26 evan Exp $
//
...
public:
	...
	*/
	...
	/*!
	  Writes the contents of the HOOPS Include Library tree to a file.  The file extension
	  denotes the file type:  hmf = HOOPS Metafile, tif = TIFF Image file, ps = Postscript. hsf = HOOPS Stream File.
	  ...
	  \param pHView A pointer to the HBaseView object containing the view-dependent information writing out the model 
	...
	*/
	...
	/*!
	  ...
	  \param FileName A character pointer denoting the name of the file to write 
	  \param pHView A pointer to the HBaseView object containing the view-dependent information writing out the model 
	  \param width An integer denoting the width in inches
	  \param height An integer denoting the height in inches
	  \return HFileOutputResult with result of the attempted file write.
	*/
