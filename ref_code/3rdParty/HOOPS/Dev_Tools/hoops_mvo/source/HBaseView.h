...
// manner of such use.
//
// $Header: /files/homes/master/cvs/hoops_master/hoops_mvo/source/HBaseView.h,v 1.492 2010-09-27 22:12:53 conor Exp $
//
...
/*!
 ...
 This class encapsulates a HOOPS segment associated with a an instance of a HOOPS driver.  This type of segment defines a
 connection to a device. (i.e. OpenGL, X11, GDI, etc...)  It's Init method creates a default segment structure under the driver
...
public:
	...
	window_handle is null, HOOPS will automatically create a native window, and manage it's updating as well as all events.
	...
	If null, HOOPS will creates it's own system colormap as necessary.
	...
	*/
	...
	/*!
	  ...
	  and it's key passed to the handle.  In the case of model output the HBaseView, HCamera and model key
	...
	*/
	...
	const char*		GetDriverPath( void ) { return (const char*)m_sDriverPath; }

	/*!  \return  A string denoting the driver type; e.g. msw, opengl, x11. */
	const char*		GetDriverType( void ) { return (const char*)m_sDriverType; }
	...
	HSelectionSet*	GetSelection( void ) { return m_pSelection; }
	...
	*/
	...
	HConstantFrameRate*	GetConstantFrameRateObject( void ) { return m_pConstantFrameRate; }
	...
	*/
	...
	HC_KEY			GetViewKey( void ) { return m_ViewKey; }	
	...
	HC_KEY			GetIncludeLinkKey( void ) { return m_lIncludeLinkKey; }	
	...
	HC_KEY			GetSceneKey( void ) { return m_SceneKey; }    
	...
	*/
	...
	float			GetZoomLimit( void ) { return m_fZoomLimit; }   
	...
	*/
	...
	HC_KEY			GetWindowspaceKey( void ) { return m_WindowspaceKey; }   
	...
	*/
	...
	HC_KEY			GetConstructionKey( void ) { return m_ConstructionKey; }   
	...
	*/
	...
	HC_KEY			GetBBoxGeometryKey( void ) { return m_BBoxGeometryKey; }   
	...
	HC_KEY			GetCuttingPlanesKey( void ) { return m_CuttingPlanesKey; }   
	...
	*/
	...
	HC_KEY			GetCuttingPlaneGeomKey( void ) { return m_CuttingPlaneGeomKey; }   
	...
	*/
	...
	HC_KEY			GetIntersectPolylinesKey( void ) { return m_IntersectPolylinesKey; }   
	...
	*/
	...
	HC_KEY			GetProgressBarKey( void ) { return m_ProgressBarKey; }	/*!< \return The key of the progress bar segment. */
...
private:
	...
	//obsolete
	HBaseView(HBaseModel *model, char * alias, char * driver_type,char * instance_name, long window_handle, long colormap) {;};

	//obsolete
	void RebindView(HBaseModel *model, char * alias, char * driver_type,char * instance_name, long window_handle, long colormap) {;};
