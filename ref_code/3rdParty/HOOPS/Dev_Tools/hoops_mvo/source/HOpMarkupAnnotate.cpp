...
// manner of such use.
//
// $Header: /files/homes/master/cvs/hoops_master/hoops_mvo/source/HOpMarkupAnnotate.cpp,v 1.73 2008-10-21 21:55:07 guido Exp $
//
// HOpMarkupAnnotate.cpp : implementation of the HOpMarkupAnnotate class
//
...
{
	return (HBaseOperator *)new HOpMarkupAnnotate(GetView(), m_bAddToLayer);
}
