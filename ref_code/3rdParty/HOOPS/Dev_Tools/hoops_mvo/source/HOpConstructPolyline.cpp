...
// manner of such use.
//
// $Header: /files/homes/master/cvs/hoops_master/hoops_mvo/source/HOpConstructPolyline.cpp,v 1.33 2007-06-04 18:33:13 reuben Exp $
//
...
{
	return (HBaseOperator *)new HOpConstructPolyline(GetView());
}
