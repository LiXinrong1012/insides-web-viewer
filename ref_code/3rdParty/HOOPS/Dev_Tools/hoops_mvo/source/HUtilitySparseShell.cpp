 ...
 * manner of such use.
 *
 *$Header: /files/homes/master/cvs/hoops_master/hoops_mvo/source/HUtilitySparseShell.cpp,v 1.4 2008-08-07 00:14:46 jason Exp $
 */
...
HUtilitySparseShell::HUtilitySparseShell (bool needPairToIndex, bool needIndexToPair) 
{
...
HUtilitySparseShell::~HUtilitySparseShell () 
{
	int i;
...
void HUtilitySparseShell::ExpandSharedVertices()
{
...
void HUtilitySparseShell::ExpandShellLookup(int range_count)
{
...
void HUtilitySparseShell::	ExpandPairToIndices()
{
...
void HUtilitySparseShell::AddOneIndexToPair (int bigIndex, int littleIndex)
{
	if (m_i2p) {
...
void HUtilitySparseShell::RemoveOneTranslation (HC_KEY key, int littleIndex)
{
...
int HUtilitySparseShell::GetPairCount (int bigIndex) const
{
...
bool HUtilitySparseShell::GetPair (int bigIndex, int n, HC_KEY *key, int *littleIndex) const
{
...
bool HUtilitySparseShell::GetPairs (int bigIndex, HC_KEY *keys, int *littleIndices) const 
{
	int i, count;
...
bool HUtilitySparseShell::GetIndex (HC_KEY key, int littleIndex, int *bigIndex) const
{
	int i;
...
void HUtilitySparseShell::AddOneTranslation (void *arg1, void *arg2, void *arg3)
{
	MVO_POINTER_SIZED_INT littleIndex = (MVO_POINTER_SIZED_INT)arg1;
	MVO_POINTER_SIZED_INT bigIndex = (MVO_POINTER_SIZED_INT)arg2;
	HUtilitySparseShell *im = (HUtilitySparseShell *)arg3;
...
HC_KEY HUtilitySparseShell::KInsertShell (
	   int point_count, 
	   const HPoint *points, 
...
void HUtilitySparseShell::DeleteByKey (
	   HC_KEY key)
{
...
void HUtilitySparseShell::EditShellPoints (
		HC_KEY key, 
