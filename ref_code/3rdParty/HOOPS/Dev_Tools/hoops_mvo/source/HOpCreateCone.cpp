...
// manner of such use.
//
// $Header: /files/homes/master/cvs/hoops_master/hoops_mvo/source/HOpCreateCone.cpp,v 1.55 2007-06-13 17:46:40 heppe Exp $
//
...
{
	return (HBaseOperator *)new HOpCreateCone(GetView());
}
