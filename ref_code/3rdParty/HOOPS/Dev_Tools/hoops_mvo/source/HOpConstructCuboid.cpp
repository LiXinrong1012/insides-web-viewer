...
// manner of such use.
//
// $Header: /files/homes/master/cvs/hoops_master/hoops_mvo/source/HOpConstructCuboid.cpp,v 1.25 2007-06-06 21:30:18 reuben Exp $
//
...
{
	return (HBaseOperator *)new HOpConstructCuboid(GetView());
}
