...
// manner of such use.
//
// $Header: /files/homes/master/cvs/hoops_master/hoops_mvo/source/HImHideOverlappedText.h,v 1.14 2008-02-15 23:05:32 stage Exp $
//
...
private:
	...
	*/
	...
	/*! This method sorts the vertices according to their z-values. QuickSort is used here, 
		but we try to be intelligent about our choice of pivots. We use the median 
		of the start-, mid-, and end-point as our pivot.  This function is recursive, 
		and should take O(log(n)) stack space.
		\param ileft The start of the array of TextListNode pointers.
		\param ileft The end of the array of TextListNode pointers.
	*/
	static void zsort(struct text_node_s **ileft, struct text_node_s **iright);
