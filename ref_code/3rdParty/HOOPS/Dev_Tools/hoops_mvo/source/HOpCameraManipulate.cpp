...
// manner of such use.
//
// $Header: /files/homes/master/cvs/hoops_master/hoops_mvo/source/HOpCameraManipulate.cpp,v 1.24 2008-07-31 19:18:41 guido Exp $
//
...
{
	HOpCameraManipulate* op = (HOpCameraManipulate*) user_data;
...
//
HOpCameraManipulate::HOpCameraManipulate(HBaseView* view, int DoRepeat,int DoCapture, HBaseOperator *OrbitOperator, HBaseOperator *PanOperator, HBaseOperator *ZoomOperator, HBaseOperator *RelativeOrbitOperator, bool AllowHandleActivation) : HBaseOperator(view, DoRepeat, DoCapture)
{
...
{
	return (HBaseOperator *)new HOpCameraManipulate(GetView());
}


 

const char * HOpCameraManipulate::GetName() { return "HOpCameraManipulate"; }
...
bool const HOpCameraManipulate::OperatorStarted( void )
{
