...
// manner of such use.
//
// $Header: /files/homes/master/cvs/hoops_master/hoops_mvo/source/HModelInfo.cpp,v 1.39 2009-04-10 02:02:42 nathan Exp $
//
...
void HModelInfo::ComputeSegmentContents(HC_KEY the_key, bool recurse)
{
	...
	if(the_key != INVALID_KEY){
		HC_Open_Segment_By_Key (the_key);
			...
			HC_Begin_Contents_Search (".", "geometry, includes, segment, modelling matrix"); 
