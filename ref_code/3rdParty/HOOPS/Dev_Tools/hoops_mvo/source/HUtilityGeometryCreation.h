...
// manner of such use.
//
// $Header: /files/homes/master/cvs/hoops_master/hoops_mvo/source/HUtilityGeometryCreation.h,v 1.54 2010-07-16 22:45:05 ann Exp $
//
...
public:
	...
	*/	
	...
	/*!
		...
		of the currently open segment. The two reference axes must be orthogonal.
		\param center An HPoint object denoting the center of the cylinder.
...
private:
	...
	*/
    static void GenerateCuboidPoints( HPoint * max, HPoint * in, HPoint * points);
