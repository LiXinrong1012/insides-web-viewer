...
// manner of such use.
//
// $Header: /files/homes/master/cvs/hoops_master/hoops_mvo/source/HOpConstructCircle.cpp,v 1.11 2008-01-24 01:31:53 reuben Exp $
//
...
{
	return (HBaseOperator *)new HOpConstructCircle(GetView());
}
