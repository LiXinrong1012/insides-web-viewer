...
// manner of such use.
//
// $Header: /files/homes/master/cvs/hoops_master/hoops_mvo/source/HOpCreateRectangle.cpp,v 1.4 2008-01-26 02:11:51 reuben Exp $
//
...
{
	return (HBaseOperator *)new HOpCreateRectangle(GetView());
}
