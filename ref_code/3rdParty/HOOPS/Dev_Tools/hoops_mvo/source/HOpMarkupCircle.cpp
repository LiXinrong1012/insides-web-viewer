...
// manner of such use.
//
// $Header: /files/homes/master/cvs/hoops_master/hoops_mvo/source/HOpMarkupCircle.cpp,v 1.19 2009-05-28 21:22:15 reuben Exp $
//
...
{
	return (HBaseOperator *)new HOpMarkupCircle(GetView());
}
