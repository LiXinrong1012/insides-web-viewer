...
// manner of such use.
//
// $Header: /files/homes/master/cvs/hoops_master/hoops_mvo/source/HDB.cpp,v 1.98 2010-10-27 21:01:07 heppe Exp $
//
...
void HDB::IncrementInstanceCount( void )
{
	m_InstanceCount++;
}

void HDB::DecrementInstanceCount( void )
{
	m_InstanceCount--;
}

const char* HDB::GetInstanceBase( void )
{
	return m_pInstanceBase;
}

const char* HDB::GetDriverType( void )
{
