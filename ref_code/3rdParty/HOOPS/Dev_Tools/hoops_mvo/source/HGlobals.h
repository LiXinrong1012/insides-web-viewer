...
// manner of such use.
//
// $Header: /files/homes/master/cvs/hoops_master/hoops_mvo/source/HGlobals.h,v 1.57 2010-11-16 02:09:36 nathan Exp $
//
...
enum HFileInputResult
{
	InputOK					= 1,    //!< self-explanatory
	InputVersionMismatch	= 2,    //!< self-explanatory
	InputFail				= 3,    //!< self-explanatory
	InputNotHandled			= 4,    //!< self-explanatory
	InputBadFileName		= 5,    //!< self-explanatory
	InputBadOptions			= 6     //!< self-explanatory
};


/*! \def LAST_HFileInputResult
    \brief Specifies last file input type
*/
...
enum HFileOutputResult
{
	OutputOK				= 1,    //!< self-explanatory
	OutputVersionMismatch	= 2,    //!< self-explanatory
	OutputFail				= 3,    //!< self-explanatory
	OutputNotHandled		= 4,    //!< self-explanatory
	OutputBadFileName		= 5,    //!< self-explanatory
	OutputBadOptions		= 6     //!< self-explanatory
};
...
public:
	...
	bool Equal(HPlane const *p, float epsi1 = HPOINT_EPSILON, float epsi2 = HPOINT_EPSILON) const { 
		return (bool)(
			(m_a - p->m_a < epsi1) && (m_a - p->m_a > -epsi1) &&
