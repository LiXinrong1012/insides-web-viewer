...
// manner of such use.
//
// $Header: /files/homes/master/cvs/hoops_master/hoops_mvo/source/HOpObjectRotate.cpp,v 1.90 2011-01-09 07:00:32 heppe Exp $
//
...
{
	return (HBaseOperator *)new HOpObjectRotate(GetView());
}
