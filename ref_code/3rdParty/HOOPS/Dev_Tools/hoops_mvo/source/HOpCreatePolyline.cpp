...
// manner of such use.
//
// $Header: /files/homes/master/cvs/hoops_master/hoops_mvo/source/HOpCreatePolyline.cpp,v 1.4 2008-01-26 01:38:23 reuben Exp $
//
...
{
	return (HBaseOperator *)new HOpCreatePolyline(GetView());
}
