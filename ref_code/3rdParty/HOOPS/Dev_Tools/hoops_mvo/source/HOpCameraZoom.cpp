...
// manner of such use.
//
// $Header: /files/homes/master/cvs/hoops_master/hoops_mvo/source/HOpCameraZoom.cpp,v 1.70 2010-09-14 18:32:31 boni Exp $
//
...
{
	return (HBaseOperator *)new HOpCameraZoom(GetView());
}
