...
// manner of such use.
//
// $Header: /files/homes/master/cvs/hoops_master/hoops_mvo/source/HConstantFrameRate.cpp,v 1.136 2010-06-16 03:19:21 covey Exp $
//

/* HConstantFrameRate.cpp
 * implements functionality to maintain a preset framerate by dynamically adjusting the
 * detail level of the scene
 *
 * Copyright 2000 by Tech Soft 3D
 */
...
void HConstantFrameRate::Watch()
{
	...
	{			
		...
		m_bFirstIncrease = true;
		float lowtarget = 1.0f / (m_TargetFrameRate *0.5);
