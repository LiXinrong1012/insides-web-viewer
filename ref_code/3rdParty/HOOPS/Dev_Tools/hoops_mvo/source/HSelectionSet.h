...
// manner of such use.
//
// $Header: /files/homes/master/cvs/hoops_master/hoops_mvo/source/HSelectionSet.h,v 1.119 2010-11-16 02:09:36 nathan Exp $
//
...
public:
	...
	*/
	...
	/*! Adds the geometry identified by 'key' to the selection list and highlights the indicated sub-elements.
		...
		\param vertex1 Array of indices into the points array of the geometry specified by key.  Each one of these 
	...
	*/
	...
	/*! Returns the value of a given list item.  Note: if it is important that 
		...
		\return The item at a given offset within the list. Returns 0, INVALID_KEY if no item is found.
	*/
