...
public:
	...
	virtual TK_Status ReadBuffer (char alter * buffer, int size, int alter & data_read) alter;
    virtual TK_Status PositionFile (int offset) alter;
	virtual TK_Status OpenFile (char const * name, bool write) alter;
    ...
    virtual TK_Status LocateDictionary (int type) alter;
    virtual TK_Status LocateDictionary () alter { return LocateDictionary(ReadDictionary); };
...
TK_Status HStreamerTK::OpenFile (char const * name, bool write) alter 
{
...
TK_Status HStreamerTK::CloseFile (void) alter
{
	strcpy(m_tkFile,"");
...
TK_Status HStreamerTK::ReadBuffer (char alter * buffer, int s_size, int alter & data_id) alter
{
...
*/
TK_Status HStreamerTK::LocateDictionary (int dic_type) alter 
{
...
/*!
    ...
    \return The result of function call -- either TK_Normal or TK_Error.
*/
TK_Status HStreamerTK::PositionFile (int offset) alter 
{
