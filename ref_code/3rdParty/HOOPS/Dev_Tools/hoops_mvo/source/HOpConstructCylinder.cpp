...
// manner of such use.
//
// $Header: /files/homes/master/cvs/hoops_master/hoops_mvo/source/HOpConstructCylinder.cpp,v 1.4 2007-06-05 18:56:54 reuben Exp $
//
...
{
	return (HBaseOperator *)new HOpConstructCylinder(GetView());
}
