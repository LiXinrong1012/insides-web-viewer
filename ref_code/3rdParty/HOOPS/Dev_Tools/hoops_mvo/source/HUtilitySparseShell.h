 ...
 * manner of such use.
 *
 *$Header: /files/homes/master/cvs/hoops_master/hoops_mvo/source/HUtilitySparseShell.h,v 1.3 2007-11-13 22:31:16 jason Exp $
 */


#ifndef _HUTILITYSPARSE_SHELL_H
#define _HUTILITYSPARSE_SHELL_H
...
class MVO_API HUtilitySparseShell
{
  private:
  ...
  public: 
	...
	/*! Calls through to HOOPS to remove the item.  If the item was inserted by 
		HUtilitySparseShell::KInsertShell, this function additionally removes the 
