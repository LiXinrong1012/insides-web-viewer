...
// manner of such use.
//
// $Header: /files/homes/master/cvs/hoops_master/hoops_mvo/source/HIOUtilityHTML.cpp,v 1.20 2010-09-29 19:09:44 trask Exp $
//
...
HFileOutputResult HIOUtilityHTML::FileOutputByKey(const wchar_t * FileName, HC_KEY key, HOutputHandlerOptions * options) 
{
	...
	fputs(H_FORMAT_TEXT(
		...
		"<script type=\"text/javascript\">\n"
			...
			"			document.write('<object classid =\"clsid:AD5F3C4B-BD73-11D5-838B-0050042DF1E4\"""codebase=\"http://developer.techsoft3d.com/downloads/HOOPSATL/hoopsatlcontrol.cab#version=-1,-1,-1,-1\" ""width=\"""%d""%%\" height=\"""%d""%%\">');\n"
