...
// manner of such use.
//
// $Header: /files/homes/master/cvs/hoops_master/hoops_mvo/source/HGraph.h,v 1.25 2009-09-02 17:49:21 nathan Exp $
//
...
{
public:
	HGraphAxis():visible(true), axis_scale(AxisScaleLinear), axis_scale_factor(1.0), tick_frequency(1.0), 
		tick_size(0.1), precision(-1), show_labels(true), grid_frequency(1.0), grid_min(-4.0), grid_max(4.0),
		segment(INVALID_KEY) {min=-4.0; max=4.0;}
