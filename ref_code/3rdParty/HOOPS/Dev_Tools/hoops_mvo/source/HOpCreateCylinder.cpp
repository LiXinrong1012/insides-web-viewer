...
// manner of such use.
//
// $Header: /files/homes/master/cvs/hoops_master/hoops_mvo/source/HOpCreateCylinder.cpp,v 1.57 2007-06-13 17:46:52 heppe Exp $
//
...
{
	return (HBaseOperator *)new HOpCreateCylinder(GetView());
}
