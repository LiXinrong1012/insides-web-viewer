...
// manner of such use.
//
// $Header: /files/homes/master/cvs/hoops_master/hoops_mvo/source/HOpCameraManipulate.h,v 1.27 2008-07-31 19:18:41 guido Exp $
//
...
public:
	...
	*/
	...
	virtual bool const OperatorStarted( void );
 
    /*!  
	 \return A pointer to the orbit operator.
    */    
	HOpCameraOrbit *GetOrbitOperator() { return (HOpCameraOrbit *)m_pOrbitOperator; }	    
