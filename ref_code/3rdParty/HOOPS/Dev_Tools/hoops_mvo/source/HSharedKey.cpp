...
// manner of such use.
//
// $Header: /files/homes/master/cvs/hoops_master/hoops_mvo/source/HSharedKey.cpp,v 1.16 2007-03-08 22:46:53 stage Exp $
//
...
{
	long ident;
	if ((ident = (long) (MVO_POINTER_SIZED_INT) vhash_lookup(m_pKeyIdentHashTable, (void *)key)))
	{
...
{
	return ((HC_KEY)vhash_lookup(m_pIdentKeyHashTable,(void *)(MVO_POINTER_SIZED_INT)ident));
}

long HSharedKey::GetIdentFromKey(HC_KEY key)
{
	return ((long)(MVO_POINTER_SIZED_INT)vhash_lookup(m_pKeyIdentHashTable,(void *)key));
}
