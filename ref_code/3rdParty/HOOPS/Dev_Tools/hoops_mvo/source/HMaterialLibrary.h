...
// manner of such use.
//
// $Header: /files/homes/master/cvs/hoops_master/hoops_mvo/source/HMaterialLibrary.h,v 1.31 2011-01-14 21:27:50 heppe Exp $
//
...
protected:
	...
	*/
	...
	/*! \param name the name of the material be compiled.
		...
		\return true on success */ 
	bool Compile (const char *name, void alter *bufferlist);
