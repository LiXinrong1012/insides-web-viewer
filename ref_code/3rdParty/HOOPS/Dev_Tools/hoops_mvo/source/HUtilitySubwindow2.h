...
// manner of such use.
//
// $Header: /files/homes/master/cvs/hoops_master/hoops_mvo/source/HUtilitySubwindow2.h,v 1.2 2008-04-01 22:05:15 guido Exp $
//
...
public:
 	...
 	*/	    
    virtual void Insert(float left, float right, float bottom, float top, char *title = 0, float minwidth = 0, float minheight = 0,int type = SUBWINDOW_NOTYPE,long appearance = 
