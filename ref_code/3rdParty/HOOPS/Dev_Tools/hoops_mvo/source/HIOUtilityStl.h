...
// manner of such use.
//
// $Header: /files/homes/master/cvs/hoops_master/hoops_mvo/source/HIOUtilityStl.h,v 1.21 2008-12-16 18:46:49 guido Exp $
//
...
private:
	...
	static HFileOutputResult ComputeStlTriangles(HC_KEY the_key, stl_info *info, HOutputHandlerOptions *options);
};
