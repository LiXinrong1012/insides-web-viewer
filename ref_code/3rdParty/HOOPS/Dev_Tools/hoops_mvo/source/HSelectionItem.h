...
// manner of such use.
//
// $Header: /files/homes/master/cvs/hoops_master/hoops_mvo/source/HSelectionItem.h,v 1.33 2010-11-16 02:09:36 nathan Exp $
//
...
private:
	...
	HC_KEY		m_QuickHighlightGeom;		//!< Key pointing to the copied geometry used in quick moves overlay highlighting
...
public:
	...
	*/
	HSubentitySelItem(HC_KEY key, HSelectionSet * selection_set, int incl_count, HC_KEY * incl_keys, 
...
public:
	...
	*/
	...
	virtual void GetIncludeKeys(HC_KEY*) const { do {/*nothing*/} while(0); }
