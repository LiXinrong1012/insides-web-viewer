...
// manner of such use.
//
// $Header: /files/homes/master/cvs/hoops_master/hoops_mvo/source/HConstantFrameRate.h,v 1.52 2009-11-18 23:54:11 evan Exp $
//
...
public:
	/*! The default constructor. */
	HFrLodClamp() : HConstFRSimpType()  { m_bSegmentSwitch = false; } 
	/*! The constructor that allows you the set the minimum and maximum simplification levels.
	\param min The minimum simplification level.
	\param max The maximum simplification level.
	*/
	HFrLodClamp(int min, int max) : HConstFRSimpType(min,max) {}
...
public:
	...
	HBaseView* GetView( void ) { return m_pHView; }	/*!< \return A pointer to the HBaseView object. */
...
public:
	...
	*/ 	
	...
	float			GetTargetFrameRate( void ) { return m_TargetFrameRate;	}	
