...
// manner of such use.
//
// $Header: /files/homes/master/cvs/hoops_master/hoops_mvo/source/HErrorManager.h,v 1.7 2009-09-01 20:19:45 jason Exp $
//
...
public:
	...
	*/
	...
	char **m_message;//!< The list messages associated with the error.
	int m_stacklength;//!< The length of the call stack.
	char **m_stack;//!< The list of functions that generated the error.
