...
// manner of such use.
//
// $Header: /files/homes/master/cvs/hoops_master/hoops_mvo/source/HOpCreateSphere.cpp,v 1.51 2007-10-17 21:09:49 nathan Exp $
//
...
{
	return (HBaseOperator *)new HOpCreateSphere(GetView());
}
