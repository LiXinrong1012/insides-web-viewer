...
// manner of such use.
//
// $Header: /files/homes/master/cvs/hoops_master/hoops_mvo/source/HUtilityQuadTree.h,v 1.8 2007-11-13 22:31:16 jason Exp $
//
...
public:
    ...
    HQuadTreeItem( float Left=-1.0f, float Bottom=-1.0f,
...
public:
    ...
    HQuadTree(float Left=-1.0f, float Bottom=-1.0,
