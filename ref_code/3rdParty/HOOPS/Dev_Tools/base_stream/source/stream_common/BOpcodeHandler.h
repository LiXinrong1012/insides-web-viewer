...
// $Header: /files/homes/master/cvs/hoops_master/shared/stream_common/BOpcodeHandler.h,v 1.494 2010-11-24 00:38:48 covey Exp $
...
class BBINFILETK_API2 BBaseOpcodeHandler : public BControlledMemoryObject {
	...
	public:
		...
		*/
		char alter *    GetLoggingString () alter               { return m_debug_string; }
...
class BBINFILETK_API TK_File_Info : public BBaseOpcodeHandler {
	...
	public:
		...
		int             GetFlags () alter                   { return m_flags;   }
};
...
class BBINFILETK_API TK_Comment : public BBaseOpcodeHandler {
	...
	public:
		...
		*/
		char alter *    GetComment () alter                 { return m_comment; }
};
	...
	public:
		...
		*/
		...
		/*! 
		  ...
		  which may then be modified directly
		*/
		char alter *    GetSegment () alter                 { return m_string; }
};
	...
	public:
		...
		*/
		...
		/*! 
		  ...
		  which may then be modified directly
		*/
		char alter *    GetCondition () alter                 { return m_condition; }


		/*! Sets the flag indicating whether the reference segment should be processed itself */
		void            SetFollow (bool f) alter                { m_follow = f;     }
		/*! Returns the flag indicating whether the reference segment should be processed itself */
		bool            GetFollow () alter                  { return m_follow;  }
};
...
class BBINFILETK_API TK_Reference : public BBaseOpcodeHandler {
	...
	public:
		...
		ID_Key          GetIndex () alter                  { return m_index;	}
...
class BBINFILETK_API TK_Delete_Object : public BBaseOpcodeHandler {
	...
	public:
		...
		int			GetIndex () alter						{ return m_index;	}
};
...
enum TKO_Geometry_Bits {
	...
	TKO_Geo_All_Colors      = 0x037F7F7F, 	//!< extra item for color; refer to ::HC_Set_Color for a description
...
class BBINFILETK_API TK_Color : public BBaseOpcodeHandler {
		...
		*/
		class BBINFILETK_API channel {
			public:
				...
				void    Reset () alter  { ::delete [] m_name;  m_name = 0; }	//!< internal use
		};
	...
	public:
		...
		void            SetChannels (int c) alter  {
							m_channels = (short)c;
							if ((c & (~0 << (TKO_Channel_Extended_Shift))) != 0)
								m_channels |= (1 << TKO_Channel_Extended);
						}
		...
		char alter *    GetDiffuseName () alter                     { return m_diffuse.m_name;              }
		...
		char alter *    GetSpecularName () alter                    { return m_specular.m_name;             }
		...
		char alter *    GetMirrorName () alter                      { return m_mirror.m_name;               }
		...
		char alter *    GetTransmissionName () alter                  { return m_transmission.m_name;              }
		...
		char alter *    GetEmissionName () alter                    { return m_emission.m_name;             }
		...
		char alter *    GetEnvironmentName () alter                 { return m_environment.m_name;              }
		...
		char alter *    GetBumpName () alter                        { return m_bump.m_name;                 }
...
class BBINFILETK_API TK_Color_Map : public BBaseOpcodeHandler {
	...
	public:
		/*! constructor */
		TK_Color_Map ()
			: BBaseOpcodeHandler (TKE_Color_Map), m_length (0), m_values (0), m_string (0), m_format (TKO_Map_RGB_Values) {}
		~TK_Color_Map();
		...
		*/
		...
		float alter *   GetValues () alter                                  { return m_values;              }
		...
		*/
		...
		/*! 
		  ...
		  buffer, which may then be modified directly
		*/
		char alter *    GetString () alter                 { return m_string; }
};
...
class BBINFILETK_API TK_Callback : public BBaseOpcodeHandler {
	...
	public:
		...
		char alter *    GetCallback () alter                    { return m_string;          }
};
...
class BBINFILETK_API TK_Rendering_Options : public BBaseOpcodeHandler {
	protected:
		...
		int             m_forced_mask;            //!< For internal use only.
		int             m_forced_value;           //!< For internal use only.
		int             m_forced_color_mask;      //!< For internal use only.
		int             m_forced_color_value;     //!< For internal use only.
		short           m_forced_color_face_mask;      //!< For internal use only.
		short           m_forced_color_face_value;     //!< For internal use only.
		short           m_forced_color_edge_mask;      //!< For internal use only.
		short           m_forced_color_edge_value;     //!< For internal use only.
		short           m_forced_color_line_mask;      //!< For internal use only.
		short           m_forced_color_line_value;     //!< For internal use only.
		short           m_forced_color_marker_mask;      //!< For internal use only.
		short           m_forced_color_marker_value;     //!< For internal use only.
		short           m_forced_color_text_mask;      //!< For internal use only.
		short           m_forced_color_text_value;     //!< For internal use only.
		short           m_forced_color_window_mask;      //!< For internal use only.
		short           m_forced_color_window_value;     //!< For internal use only.
		short           m_forced_color_face_contrast_mask;      //!< For internal use only.
		short           m_forced_color_face_contrast_value;     //!< For internal use only.
		short           m_forced_color_window_contrast_mask;      //!< For internal use only.
		short           m_forced_color_window_contrast_value;     //!< For internal use only.
		short           m_forced_color_back_mask;      //!< For internal use only.
		short           m_forced_color_back_value;     //!< For internal use only.
		short           m_forced_color_vertex_mask;      //!< For internal use only.
		short           m_forced_color_vertex_value;     //!< For internal use only.
		short           m_forced_color_edge_contrast_mask;      //!< For internal use only.
		short           m_forced_color_edge_contrast_value;     //!< For internal use only.
		short           m_forced_color_line_contrast_mask;      //!< For internal use only.
		short           m_forced_color_line_contrast_value;     //!< For internal use only.
		short           m_forced_color_marker_contrast_mask;      //!< For internal use only.
		short           m_forced_color_marker_contrast_value;     //!< For internal use only.
		short           m_forced_color_vertex_contrast_mask;      //!< For internal use only.
		short           m_forced_color_vertex_contrast_value;     //!< For internal use only.
		short           m_forced_color_text_contrast_mask;      //!< For internal use only.
		short           m_forced_color_text_contrast_value;     //!< For internal use only.
		short           m_forced_color_simple_reflection_mask;      //!< For internal use only.
		short           m_forced_color_simple_reflection_value;     //!< For internal use only.
		short           m_forced_color_cut_face_mask;      //!< For internal use only.
		short           m_forced_color_cut_face_value;     //!< For internal use only.
		short           m_forced_color_cut_edge_mask;      //!< For internal use only.
		short           m_forced_color_cut_edge_value;     //!< For internal use only.
		int             m_forced_visibility_mask; //!< For internal use only.
		int             m_forced_visibility_value;//!< For internal use only.
	...
	public:
		...
		void            SetValue (int v0, int v1=0, int v2=0) alter   { m_value[0] = v0; m_value[1] = v1; m_value[2] = v2; }
		...
		void            SetTransparentStyle (int s) alter { m_transparency_options = (unsigned short)s;      }
		...
		void            SetVertexDisplacement (int d) alter   { m_vertex_displacement = d;                      }
		...
		int             GetLockMask () const                { return m_lock_mask;               }
		...
		int             GetLockValue () const               { return m_lock_value;              }
		...
		*/
		...
		/*!
			...
			specified by #TKO_Geometry_Bits.
		*/
		int             GetVisibilityLockMask () const      { return m_lock_visibility_mask;    }
		...
		*/
		...
		/*!
			...
			specified by #TKO_Geometry_Bits.
		*/
		int             GetVisibilityLockValue () const     { return m_lock_visibility_value;   }
		...
		*/
		...
		/*!
			...
			specified by #TKO_Geometry_Bits.
		*/
		int             GetColorLockMask () const      { return m_lock_color_mask;    }
		...
		*/
		...
		/*!
			...
			specified by #TKO_Geometry_Bits.
		*/
		int             GetColorLockValue () const     { return m_lock_color_value;   }
		...
		*/
		...
		/*!
			...
			specified by #TKO_Color_Channel_Lock_Bits.
		*/
		int             GetColorFaceLockMask () const           { return m_lock_color_face_mask;         }
		...
		*/
		...
		/*!
			...
			specified by #TKO_Color_Channel_Lock_Bits.
		*/
		int             GetColorFaceLockValue () const          { return m_lock_color_face_value;        }
		...
		*/
		...
		/*!
			...
			specified by #TKO_Color_Channel_Lock_Bits.
		*/
		int             GetColorEdgeLockMask () const           { return m_lock_color_edge_mask;         }
		...
		*/
		...
		/*!
			...
			specified by #TKO_Color_Channel_Lock_Bits.
		*/
		int             GetColorEdgeLockValue () const          { return m_lock_color_edge_value;        }
		...
		*/
		...
		/*!
			...
			specified by #TKO_Color_Channel_Lock_Bits.
		*/
		int             GetColorLineLockMask () const           { return m_lock_color_line_mask;         }
		...
		*/
		...
		/*!
			...
			specified by #TKO_Color_Channel_Lock_Bits.
		*/
		int             GetColorLineLockValue () const          { return m_lock_color_line_value;        }
		...
		*/
		...
		/*!
			...
			specified by #TKO_Color_Channel_Lock_Bits.
		*/
		int             GetColorMarkerLockMask () const           { return m_lock_color_marker_mask;         }
		...
		*/
		...
		/*!
			...
			specified by #TKO_Color_Channel_Lock_Bits.
		*/
		int             GetColorMarkerLockValue () const          { return m_lock_color_marker_value;        }
		...
		*/
		...
		/*!
			...
			specified by #TKO_Color_Channel_Lock_Bits.
		*/
		int             GetColorTextLockMask () const           { return m_lock_color_text_mask;         }
		...
		*/
		...
		/*!
			...
			specified by #TKO_Color_Channel_Lock_Bits.
		*/
		int             GetColorTextLockValue () const          { return m_lock_color_text_value;        }
		...
		*/
		...
		/*!
			...
			specified by #TKO_Color_Channel_Lock_Bits.
		*/
		int             GetColorWindowLockMask () const           { return m_lock_color_window_mask;         }
		...
		*/
		...
		/*!
			...
			specified by #TKO_Color_Channel_Lock_Bits.
		*/
		int             GetColorWindowLockValue () const          { return m_lock_color_window_value;        }
		...
		*/
		...
		/*!
			...
			specified by #TKO_Color_Channel_Lock_Bits.
		*/
		int             GetColorFaceContrastLockMask () const           { return m_lock_color_face_contrast_mask;         }
		...
		*/
		...
		/*!
			...
			specified by #TKO_Color_Channel_Lock_Bits.
		*/
		int             GetColorFaceContrastLockValue () const          { return m_lock_color_face_contrast_value;        }
		...
		*/
		...
		/*!
			...
			specified by #TKO_Color_Channel_Lock_Bits.
		*/
		int             GetColorWindowContrastLockMask () const           { return m_lock_color_window_contrast_mask;         }
		...
		*/
		...
		/*!
			...
			specified by #TKO_Color_Channel_Lock_Bits.
		*/
		int             GetColorWindowContrastLockValue () const          { return m_lock_color_window_contrast_value;        }
		...
		*/
		...
		/*!
			...
			specified by #TKO_Color_Channel_Lock_Bits.
		*/
		int             GetColorBackLockMask () const           { return m_lock_color_back_mask;         }
		...
		*/
		...
		/*!
			...
			specified by #TKO_Color_Channel_Lock_Bits.
		*/
		int             GetColorBackLockValue () const          { return m_lock_color_back_value;        }
		...
		*/
		...
		/*!
			...
			specified by #TKO_Color_Channel_Lock_Bits.
		*/
		int             GetColorVertexLockMask () const           { return m_lock_color_vertex_mask;         }
		...
		*/
		...
		/*!
			...
			specified by #TKO_Color_Channel_Lock_Bits.
		*/
		int             GetColorVertexLockValue () const          { return m_lock_color_vertex_value;        }
		...
		*/
		...
		/*!
			...
			specified by #TKO_Color_Channel_Lock_Bits.
		*/
		int             GetColorEdgeContrastLockMask () const           { return m_lock_color_edge_contrast_mask;         }
		...
		*/
		...
		/*!
			...
			specified by #TKO_Color_Channel_Lock_Bits.
		*/
		int             GetColorEdgeContrastLockValue () const          { return m_lock_color_edge_contrast_value;        }
		...
		*/
		...
		/*!
			...
			specified by #TKO_Color_Channel_Lock_Bits.
		*/
		int             GetColorLineContrastLockMask () const           { return m_lock_color_line_contrast_mask;         }
		...
		*/
		...
		/*!
			...
			specified by #TKO_Color_Channel_Lock_Bits.
		*/
		int             GetColorLineContrastLockValue () const          { return m_lock_color_line_contrast_value;        }
		...
		*/
		...
		/*!
			...
			specified by #TKO_Color_Channel_Lock_Bits.
		*/
		int             GetColorMarkerContrastLockMask () const           { return m_lock_color_marker_contrast_mask;         }
		...
		*/
		...
		/*!
			...
			specified by #TKO_Color_Channel_Lock_Bits.
		*/
		int             GetColorMarkerContrastLockValue () const          { return m_lock_color_marker_contrast_value;        }
		...
		*/
		...
		/*!
			...
			specified by #TKO_Color_Channel_Lock_Bits.
		*/
		int             GetColorVertexContrastLockMask () const           { return m_lock_color_vertex_contrast_mask;         }
		...
		*/
		...
		/*!
			...
			specified by #TKO_Color_Channel_Lock_Bits.
		*/
		int             GetColorVertexContrastLockValue () const          { return m_lock_color_vertex_contrast_value;        }
		...
		*/
		...
		/*!
			...
			specified by #TKO_Color_Channel_Lock_Bits.
		*/
		int             GetColorTextContrastLockMask () const           { return m_lock_color_text_contrast_mask;         }
		...
		*/
		...
		/*!
			...
			specified by #TKO_Color_Channel_Lock_Bits.
		*/
		int             GetColorTextContrastLockValue () const          { return m_lock_color_text_contrast_value;        }
		...
		void            SetForcedLockMask (int m) alter               { m_forced_mask = m;                  }
		...
		int             GetForcedLockMask () const                { return m_forced_mask;               }
		...
		void            SetForcedLockValue (int v) alter              { m_forced_value = v;                 }
		...
		*/
		void            SetColorFaceForcedLockMask (int m) alter          { m_forced_color_face_mask = (short)m;     }
		/*!
			Returns the mask indicating which face color channels have a forced lock setting. Color channels are 
			specified by #TKO_Color_Channel_ForcedLock_Bits.
		*/
		int             GetColorFaceForcedLockMask () const           { return m_forced_color_face_mask;         }

		/*!
			Sets the value indicating which face color channels are forceded. Color channels are 
			specified by #TKO_Color_Channel_ForcedLock_Bits.
		*/
		void            SetColorFaceForcedLockValue (int v) alter         { m_forced_color_face_value = (short)v;    }
		/*!
			Returns the value indicating which face color channels are forceded. Color channels are 
			specified by #TKO_Color_Channel_ForcedLock_Bits.
		*/
		int             GetColorFaceForcedLockValue () const          { return m_forced_color_face_value;        }
		...
		/*!
			...
			specified by #TKO_Color_Channel_ForcedLock_Bits.
		*/
		void            SetColorEdgeForcedLockMask (int m) alter          { m_forced_color_edge_mask = (short)m;     }
		/*!
			Returns the mask indicating which edge color channels have a forced lock setting. Color channels are 
			specified by #TKO_Color_Channel_ForcedLock_Bits.
		*/
		int             GetColorEdgeForcedLockMask () const           { return m_forced_color_edge_mask;         }

		/*!
			Sets the value indicating which edge color channels are forceded. Color channels are 
			specified by #TKO_Color_Channel_ForcedLock_Bits.
		*/
		void            SetColorEdgeForcedLockValue (int v) alter         { m_forced_color_edge_value = (short)v;    }
		/*!
			Returns the value indicating which edge color channels are forceded. Color channels are 
			specified by #TKO_Color_Channel_ForcedLock_Bits.
		*/
		int             GetColorEdgeForcedLockValue () const          { return m_forced_color_edge_value;        }
		...
		/*!
			...
			specified by #TKO_Color_Channel_ForcedLock_Bits.
		*/
		void            SetColorLineForcedLockMask (int m) alter          { m_forced_color_line_mask = (short)m;     }
		/*!
			Returns the mask indicating which line color channels have a forced lock setting. Color channels are 
			specified by #TKO_Color_Channel_ForcedLock_Bits.
		*/
		int             GetColorLineForcedLockMask () const           { return m_forced_color_line_mask;         }

		/*!
			Sets the value indicating which line color channels are forceded. Color channels are 
			specified by #TKO_Color_Channel_ForcedLock_Bits.
		*/
		void            SetColorLineForcedLockValue (int v) alter         { m_forced_color_line_value = (short)v;    }
		/*!
			Returns the value indicating which line color channels are forceded. Color channels are 
			specified by #TKO_Color_Channel_ForcedLock_Bits.
		*/
		int             GetColorLineForcedLockValue () const          { return m_forced_color_line_value;        }
		...
		/*!
			...
			specified by #TKO_Color_Channel_ForcedLock_Bits.
		*/
		void            SetColorMarkerForcedLockMask (int m) alter          { m_forced_color_marker_mask = (short)m;     }
		/*!
			Returns the mask indicating which marker color channels have a forced lock setting. Color channels are 
			specified by #TKO_Color_Channel_ForcedLock_Bits.
		*/
		int             GetColorMarkerForcedLockMask () const           { return m_forced_color_marker_mask;         }

		/*!
			Sets the value indicating which marker color channels are forceded. Color channels are 
			specified by #TKO_Color_Channel_ForcedLock_Bits.
		*/
		void            SetColorMarkerForcedLockValue (int v) alter         { m_forced_color_marker_value = (short)v;    }
		/*!
			Returns the value indicating which marker color channels are forceded. Color channels are 
			specified by #TKO_Color_Channel_ForcedLock_Bits.
		*/
		int             GetColorMarkerForcedLockValue () const          { return m_forced_color_marker_value;        }
		...
		/*!
			...
			specified by #TKO_Color_Channel_ForcedLock_Bits.
		*/
		void            SetColorTextForcedLockMask (int m) alter          { m_forced_color_text_mask = (short)m;     }
		/*!
			Returns the mask indicating which text color channels have a forced lock setting. Color channels are 
			specified by #TKO_Color_Channel_ForcedLock_Bits.
		*/
		int             GetColorTextForcedLockMask () const           { return m_forced_color_text_mask;         }

		/*!
			Sets the value indicating which text color channels are forceded. Color channels are 
			specified by #TKO_Color_Channel_ForcedLock_Bits.
		*/
		void            SetColorTextForcedLockValue (int v) alter         { m_forced_color_text_value = (short)v;    }
		/*!
			Returns the value indicating which text color channels are forceded. Color channels are 
			specified by #TKO_Color_Channel_ForcedLock_Bits.
		*/
		int             GetColorTextForcedLockValue () const          { return m_forced_color_text_value;        }
		...
		/*!
			...
			specified by #TKO_Color_Channel_ForcedLock_Bits.
		*/
		void            SetColorWindowForcedLockMask (int m) alter          { m_forced_color_window_mask = (short)m;     }
		/*!
			Returns the mask indicating which window color channels have a forced lock setting. Color channels are 
			specified by #TKO_Color_Channel_ForcedLock_Bits.
		*/
		int             GetColorWindowForcedLockMask () const           { return m_forced_color_window_mask;         }

		/*!
			Sets the value indicating which window color channels are forceded. Color channels are 
			specified by #TKO_Color_Channel_ForcedLock_Bits.
		*/
		void            SetColorWindowForcedLockValue (int v) alter         { m_forced_color_window_value = (short)v;    }
		/*!
			Returns the value indicating which window color channels are forceded. Color channels are 
			specified by #TKO_Color_Channel_ForcedLock_Bits.
		*/
		int             GetColorWindowForcedLockValue () const          { return m_forced_color_window_value;        }
		...
		/*!
			...
			specified by #TKO_Color_Channel_ForcedLock_Bits.
		*/
		void            SetColorFaceContrastForcedLockMask (int m) alter          { m_forced_color_face_contrast_mask = (short)m;     }
		/*!
			Returns the mask indicating which face_contrast color channels have a forced lock setting. Color channels are 
			specified by #TKO_Color_Channel_ForcedLock_Bits.
		*/
		int             GetColorFaceContrastForcedLockMask () const           { return m_forced_color_face_contrast_mask;         }

		/*!
			Sets the value indicating which face_contrast color channels are forceded. Color channels are 
			specified by #TKO_Color_Channel_ForcedLock_Bits.
		*/
		void            SetColorFaceContrastForcedLockValue (int v) alter         { m_forced_color_face_contrast_value = (short)v;    }
		/*!
			Returns the value indicating which face_contrast color channels are forceded. Color channels are 
			specified by #TKO_Color_Channel_ForcedLock_Bits.
		*/
		int             GetColorFaceContrastForcedLockValue () const          { return m_forced_color_face_contrast_value;        }
		...
		/*!
			...
			specified by #TKO_Color_Channel_ForcedLock_Bits.
		*/
		void            SetColorWindowContrastForcedLockMask (int m) alter          { m_forced_color_window_contrast_mask = (short)m;     }
		/*!
			Returns the mask indicating which window_contrast color channels have a forced lock setting. Color channels are 
			specified by #TKO_Color_Channel_ForcedLock_Bits.
		*/
		int             GetColorWindowContrastForcedLockMask () const           { return m_forced_color_window_contrast_mask;         }

		/*!
			Sets the value indicating which window_contrast color channels are forceded. Color channels are 
			specified by #TKO_Color_Channel_ForcedLock_Bits.
		*/
		void            SetColorWindowContrastForcedLockValue (int v) alter         { m_forced_color_window_contrast_value = (short)v;    }
		/*!
			Returns the value indicating which window_contrast color channels are forceded. Color channels are 
			specified by #TKO_Color_Channel_ForcedLock_Bits.
		*/
		int             GetColorWindowContrastForcedLockValue () const          { return m_forced_color_window_contrast_value;        }
		...
		/*!
			...
			specified by #TKO_Color_Channel_ForcedLock_Bits.
		*/
		void            SetColorBackForcedLockMask (int m) alter          { m_forced_color_back_mask = (short)m;     }
		/*!
			Returns the mask indicating which back color channels have a forced lock setting. Color channels are 
			specified by #TKO_Color_Channel_ForcedLock_Bits.
		*/
		int             GetColorBackForcedLockMask () const           { return m_forced_color_back_mask;         }

		/*!
			Sets the value indicating which back color channels are forceded. Color channels are 
			specified by #TKO_Color_Channel_ForcedLock_Bits.
		*/
		void            SetColorBackForcedLockValue (int v) alter         { m_forced_color_back_value = (short)v;    }
		/*!
			Returns the value indicating which back color channels are forceded. Color channels are 
			specified by #TKO_Color_Channel_ForcedLock_Bits.
		*/
		int             GetColorBackForcedLockValue () const          { return m_forced_color_back_value;        }
		...
		/*!
			...
			specified by #TKO_Color_Channel_ForcedLock_Bits.
		*/
		void            SetColorVertexForcedLockMask (int m) alter          { m_forced_color_vertex_mask = (short)m;     }
		/*!
			Returns the mask indicating which vertex color channels have a forced lock setting. Color channels are 
			specified by #TKO_Color_Channel_ForcedLock_Bits.
		*/
		int             GetColorVertexForcedLockMask () const           { return m_forced_color_vertex_mask;         }

		/*!
			Sets the value indicating which vertex color channels are forceded. Color channels are 
			specified by #TKO_Color_Channel_ForcedLock_Bits.
		*/
		void            SetColorVertexForcedLockValue (int v) alter         { m_forced_color_vertex_value = (short)v;    }
		/*!
			Returns the value indicating which vertex color channels are forceded. Color channels are 
			specified by #TKO_Color_Channel_ForcedLock_Bits.
		*/
		int             GetColorVertexForcedLockValue () const          { return m_forced_color_vertex_value;        }
		...
		/*!
			...
			specified by #TKO_Color_Channel_ForcedLock_Bits.
		*/
		void            SetColorEdgeContrastForcedLockMask (int m) alter          { m_forced_color_edge_contrast_mask = (short)m;     }
		/*!
			Returns the mask indicating which edge_contrast color channels have a forced lock setting. Color channels are 
			specified by #TKO_Color_Channel_ForcedLock_Bits.
		*/
		int             GetColorEdgeContrastForcedLockMask () const           { return m_forced_color_edge_contrast_mask;         }

		/*!
			Sets the value indicating which edge_contrast color channels are forceded. Color channels are 
			specified by #TKO_Color_Channel_ForcedLock_Bits.
		*/
		void            SetColorEdgeContrastForcedLockValue (int v) alter         { m_forced_color_edge_contrast_value = (short)v;    }
		/*!
			Returns the value indicating which edge_contrast color channels are forceded. Color channels are 
			specified by #TKO_Color_Channel_ForcedLock_Bits.
		*/
		int             GetColorEdgeContrastForcedLockValue () const          { return m_forced_color_edge_contrast_value;        }
		...
		/*!
			...
			specified by #TKO_Color_Channel_ForcedLock_Bits.
		*/
		void            SetColorLineContrastForcedLockMask (int m) alter          { m_forced_color_line_contrast_mask = (short)m;     }
		/*!
			Returns the mask indicating which line_contrast color channels have a forced lock setting. Color channels are 
			specified by #TKO_Color_Channel_ForcedLock_Bits.
		*/
		int             GetColorLineContrastForcedLockMask () const           { return m_forced_color_line_contrast_mask;         }

		/*!
			Sets the value indicating which line_contrast color channels are forceded. Color channels are 
			specified by #TKO_Color_Channel_ForcedLock_Bits.
		*/
		void            SetColorLineContrastForcedLockValue (int v) alter         { m_forced_color_line_contrast_value = (short)v;    }
		/*!
			Returns the value indicating which line_contrast color channels are forceded. Color channels are 
			specified by #TKO_Color_Channel_ForcedLock_Bits.
		*/
		int             GetColorLineContrastForcedLockValue () const          { return m_forced_color_line_contrast_value;        }
		...
		/*!
			...
			specified by #TKO_Color_Channel_ForcedLock_Bits.
		*/
		void            SetColorMarkerContrastForcedLockMask (int m) alter          { m_forced_color_marker_contrast_mask = (short)m;     }
		/*!
			Returns the mask indicating which marker_contrast color channels have a forced lock setting. Color channels are 
			specified by #TKO_Color_Channel_ForcedLock_Bits.
		*/
		int             GetColorMarkerContrastForcedLockMask () const           { return m_forced_color_marker_contrast_mask;         }

		/*!
			Sets the value indicating which marker_contrast color channels are forceded. Color channels are 
			specified by #TKO_Color_Channel_ForcedLock_Bits.
		*/
		void            SetColorMarkerContrastForcedLockValue (int v) alter         { m_forced_color_marker_contrast_value = (short)v;    }
		/*!
			Returns the value indicating which marker_contrast color channels are forceded. Color channels are 
			specified by #TKO_Color_Channel_ForcedLock_Bits.
		*/
		int             GetColorMarkerContrastForcedLockValue () const          { return m_forced_color_marker_contrast_value;        }
		...
		/*!
			...
			specified by #TKO_Color_Channel_ForcedLock_Bits.
		*/
		void            SetColorVertexContrastForcedLockMask (int m) alter          { m_forced_color_vertex_contrast_mask = (short)m;     }
		/*!
			Returns the mask indicating which vertex_contrast color channels have a forced lock setting. Color channels are 
			specified by #TKO_Color_Channel_ForcedLock_Bits.
		*/
		int             GetColorVertexContrastForcedLockMask () const           { return m_forced_color_vertex_contrast_mask;         }

		/*!
			Sets the value indicating which vertex_contrast color channels are forceded. Color channels are 
			specified by #TKO_Color_Channel_ForcedLock_Bits.
		*/
		void            SetColorVertexContrastForcedLockValue (int v) alter         { m_forced_color_vertex_contrast_value = (short)v;    }
		/*!
			Returns the value indicating which vertex_contrast color channels are forceded. Color channels are 
			specified by #TKO_Color_Channel_ForcedLock_Bits.
		*/
		int             GetColorVertexContrastForcedLockValue () const          { return m_forced_color_vertex_contrast_value;        }
		...
		/*!
			...
			specified by #TKO_Color_Channel_ForcedLock_Bits.
		*/
		void            SetColorTextContrastForcedLockMask (int m) alter          { m_forced_color_text_contrast_mask = (short)m;     }
		/*!
			Returns the mask indicating which text_contrast color channels have a forced lock setting. Color channels are 
			specified by #TKO_Color_Channel_ForcedLock_Bits.
		*/
		int             GetColorTextContrastForcedLockMask () const           { return m_forced_color_text_contrast_mask;         }

		/*!
			Sets the value indicating which text_contrast color channels are forceded. Color channels are 
			specified by #TKO_Color_Channel_ForcedLock_Bits.
		*/
		void            SetColorTextContrastForcedLockValue (int v) alter         { m_forced_color_text_contrast_value = (short)v;    }
		/*!
			Returns the value indicating which text_contrast color channels are forceded. Color channels are 
			specified by #TKO_Color_Channel_ForcedLock_Bits.
		*/
		int             GetColorTextContrastForcedLockValue () const          { return m_forced_color_text_contrast_value;        }
		...
		int             GetNURBSSurfaceBudget () const      { return m_curve_budget;            }
		...
		float alter *   GetLodRatios () alter               { return m_ratio;                   }
		...
		float alter *   GetLodThresholds () alter               { return m_threshold;                  }
		...
		float alter *   GetLodCutoffs () alter              { return m_cutoff;                  }
		...
		char alter *    GetCylinderTessellations () alter    { return m_cylinder;               }
		...
		char alter *    GetSphereTessellations () alter		{ return m_sphere;               }
		...
		/*! Sets the mask indicating which simple reflection options to use. */
		void            SetSimpleReflectionVisibilityMask (int m) alter		{ m_simple_reflection_visibility_mask = m;	}
		/*! Returns the mask indicating which simple reflection options are set. */
		...
		void            SetAmbientUpVector (float const * v) alter  { SetAmbientUpVector (v[0], v[1], v[2]); }
		...
		/*! Sets the rgb color value as a float triplet */
		void            SetDiffuseTextureTintColor (float const * rgb) alter { SetDiffuseTextureTintColor (rgb[0], rgb[1], rgb[2]);	}
		/*! Returns the rgb color value as the address of a float triplet */
		...
		void            SetAntiAlias (int m) alter		{ m_antialias = (unsigned char)m;	}
		...
		void            SetVertexDecimation (float f) alter		{ m_vertex_decimation = f;	}
...
class BBINFILETK_API TK_Heuristics : public BBaseOpcodeHandler {
	...
	public:
		...
		void            SetMaximumExtentMode (int c) alter         { m_maximum_extent_mode = c;		}
		/*! Gets the Maximum Extent Level */
		int				GetMaximumExtentLevel () const		   { return m_maximum_extent_level; }
		/*! Sets the Maximum Extent Level */
		void            SetMaximumExtentLevel (int c) alter         { m_maximum_extent_level = (unsigned char)c;		}
		/*! Sets the limit for hard extent culling */
		void            SetHardExtent (int c) alter         { m_hard_extent = c;		}
		...
		float alter *	GetOrderedWeights () alter					{ return m_ordered_weights;			}
		...
		void            SetForceDefer (int l) alter        { m_force_defer = l; }
...
class BBINFILETK_API TK_Geometry_Options : public BBaseOpcodeHandler {
	...
	public:
		...
		void            SetMask (int m) alter { m_mask = (unsigned short)m; }
...
class BBINFILETK_API TK_Matrix : public BBaseOpcodeHandler {
	...
	public:
		...
		float alter *   GetMatrix () alter              { return m_matrix;  }
};
...
class BBINFILETK_API TK_Named : public BBaseOpcodeHandler {
	...
	public:
		...
		char alter *    GetName () alter		    { return m_name;		}

		/*! Sets the index value */
		void            SetIndex (int i) alter  { Reset(); m_index = i;   }
		/*! Returns the index value */
		int             GetIndex () const   { return (int)m_index;		}
};
...
class BBINFILETK_API TK_Conditional_Action : public BBaseOpcodeHandler {
	...
	public:
		...
		void            SetCondition (char const * options) alter;
		...
		/*! Returns the conditions string buffer, which may be modified directly */
		char alter *    GetCondition () alter                 { return m_string;          }
		/*! Returns the size of the string buffer (number of chars, not including any space for trailing null) */
		int             GetLength() alter                   { return m_length;          }

		/*! Sets the action type. */
		void			SetAction (int at) alter	{ m_type = (short)at; }
		/*! Returns the action type. */
		int				GetAction () const			{ return (int)m_type; }
		/*! Sets the options flags. */
		void			SetOptions (int at) alter	{ m_options = (short)at; }
...
class BBINFILETK_API TK_User_Options : public BBaseOpcodeHandler {
	...
	public:
		...
		char alter *    GetOptions () alter                 { return m_string;          }
		/*! Returns the size of the string buffer (number of chars, not including any space for trailing null) */
		int             GetLength() alter                   { return m_length;          }
};
...
class BBINFILETK_API TK_Unicode_Options : public BBaseOpcodeHandler {
	...
	public:
		...
		/*! Returns the user options string buffer, which may be modified directly */
		unsigned short alter *  GetOptions () alter                 { return m_string;          }
...
class BBINFILETK_API TK_User_Index : public BBaseOpcodeHandler {
	protected:
		...
		void    set_indices (int count, int const * indices, POINTER_SIZED_INT const * values) alter;  //!< for internal use only
...
protected:
	...
	int				m_current_value;		//!< for internal use only
	void    set_indices (int count, int const indices[], void const * values[], int const sizes[]) alter;  //!< for internal use only
	void    set_indices (int count) alter;                                            //!< for internal use only
	void		FreeMem () alter;
...
public:
	...
	/*! Sets the index-value pairs.  Allocates buffers and copies the indices and values */
	void            SetIndices (int count, int const indices[], void const * values[], int const sizes[]) alter {
	...
	/*! Returns the value array buffer, which may be modified directly */
	void ** const    GetValues () alter          { return m_values;}
	...
	int alter *    GetSizes () alter          { return m_sizes;}
};
...
class BBINFILETK_API TK_User_Value : public BBaseOpcodeHandler {
	...
	public:
		...
		/*! Sets the user value */
		void            SetValue (HLONG v) alter     { m_value = v;      }
...
class BBINFILETK_API2 TK_Camera : public BBaseOpcodeHandler {
	...
	public:
		...
		float const *   GetOblique () const                 { return &m_settings[11];               }
		...
		/*! Returns the camera field size as the address of a float pair */
		float           GetNearLimit () const               { return m_settings[13];    }
		...
		char alter *    GetView () alter                    { return m_name;            }
};
...
class BBINFILETK_API TK_Text_Font : public BBaseOpcodeHandler {
	...
	public:
		...
		char alter *    GetNames () alter                   { return m_names;       }
...
class BBINFILETK_API TK_Polypoint : public BBaseOpcodeHandler {
	...
	public:
		...
		float alter *   GetPoints () alter                                  { return m_points;              }
...
class BBINFILETK_API TK_NURBS_Curve : public BBaseOpcodeHandler {
	...
	public:
		...
		float alter *   GetPoints () alter          { return m_control_points;          } /*!< Gets a mutable pointer to the control points */
		float const *   GetWeights () const         { return m_weights;                 } /*!< Gets a constant to the control point weights */
		float alter *   GetWeights () alter         { return m_weights;                 } /*!< Gets a mutable pointer to the control point weights */
		float const *   GetKnots () const           { return m_knots;                   } /*!< Gets a constant pointer to the curve knots */
		float alter *   GetKnots () alter           { return m_knots;                   } /*!< Gets a mutable pointer to the knots */
...
class BBINFILETK_API HT_NURBS_Trim : public BBaseOpcodeHandler  {
	...
	public:
		...
		float alter *   GetWeights () alter     { return m_weights; } 
		...
		float alter *   GetKnots () alter       { return m_knots;   } 
		...
		HT_NURBS_Trim *GetList () alter         { return m_list;    } 
...
class BBINFILETK_API TK_NURBS_Surface : public BBaseOpcodeHandler {
	...
	public:
		...
		void        Reset () alter; /*!< prepares the handler for reuse during reading or writing */
		...
		float alter *   GetPoints () alter          { return m_control_points;          } 
		...
		float alter *   GetUKnots () alter          { return m_u_knots;                 } 
		...
		float alter *   GetVKnots () alter          { return m_v_knots;                 } 
		...
		HT_NURBS_Trim * GetTrims () alter           { return m_trims;                   }
};
...
class BBINFILETK_API TK_Ellipse : public BBaseOpcodeHandler {
	...
	public:
		...
		float const *   GetMajor () const               { return m_major;               }
		...
		float const *   GetMinor () const               { return m_minor;               }
...
class BBINFILETK_API TK_PolyCylinder : public TK_Polyhedron {
	...
	public:
		...
		*/
		...
		/*! Returns the address of the point buffer, which may be modified directly */
		float alter *   GetRadii () alter               { return m_radii;               }
		/*! Returns the number of points in the buffer */
...
class BBINFILETK_API TK_Grid : public BBaseOpcodeHandler {
	...
	public:
		...
		float const *   GetOrigin () const              { return m_origin;              }
		...
		float const *   GetRef1 () const                { return m_ref1;                }
		...
		float const *   GetRef2 () const                { return m_ref2;                }
...
class BBINFILETK_API TK_Text : public BBaseOpcodeHandler {
	...
	public:
		...
		void            SetTextRegion (int c, float const * p, int o=0, int f=0) alter;
...
class BBINFILETK_API TK_Font : public BBaseOpcodeHandler {
	...
	public:
		...
		*/
		...
		char alter *    GetBytes () alter                               { return m_bytes;           }
		...
		char alter *    GetLookup () alter                              { return m_lookup;          }
...
class BBINFILETK_API2 TK_Image_Data_Buffer {
	...
	public:
		...
		unsigned int alter &     Used () alter      { return m_used;        }
		unsigned char const *    Buffer () const    { return m_buffer;      }
		unsigned char alter *    Buffer () alter    { return m_buffer;      }
};
...
class BBINFILETK_API2 TK_Image : public BBaseOpcodeHandler {
	...
	public:
		...
		*/
		...
		char alter *    GetReference () alter                           { return m_reference;       }
...
class BBINFILETK_API2 TK_Texture : public BBaseOpcodeHandler {
	...
	public:
		...
		char alter *    GetShaderSource () alter							{ return m_shader_source;                }
		...
		char alter *    GetImage () alter                       { return m_image;               }
		...
		char alter *    GetCamera () alter                       { return m_camera;               }
		...
		int             GetApplicationMode () const             { return (int)m_tiling;         }
		...
		*/
		...
		char alter *    GetTransform () alter                   { return m_transform;           }
};
...
class BBINFILETK_API2 TK_Thumbnail : public BBaseOpcodeHandler {
	...
	TK_Thumbnail() : BBaseOpcodeHandler (TKE_Thumbnail), m_bytes (0), m_format (TKO_Thumbnail_Invalid) {}
		...
		*/
		...
		/*! Returns the address of the data buffer, which may be modified directly */
		unsigned char alter *    GetBytes () alter                   { return m_bytes;			}
...
class BBINFILETK_API2 TK_Glyph_Definition : public BBaseOpcodeHandler {
	...
	public:
		...
		char alter *    GetDefinition () alter		{ return m_data;	}
};
	...
	public:
		...
		*/
		...
		/*! 
		  ...
		  which may then be modified directly
		*/
		char alter *    GetSegment () alter                 { return m_segment; }
};
...
class BBINFILETK_API2 TK_Line_Style : public BBaseOpcodeHandler {
	...
	public:
		...
		/*! Returns the definition buffer, which can be modified directly */
		char alter *    GetDefinition () alter  { return m_definition;	}
};
...
class BBINFILETK_API2 TK_User_Data : public BBaseOpcodeHandler {
	protected:
		...
		//! internal use
		void    set_data (int size, unsigned char const * bytes = 0) alter;  //!< for internal use only
	...
	public:
		...
		*/
		void            SetUserData (int size, unsigned char const * bytes = 0) alter    { set_data (size, bytes);   }
		/*! Returns the address of the data buffer */
		unsigned char const *    GetUserData () const                                { return m_data;            }
		/*! Returns the address of the data buffer, which may be modified directly */
		unsigned char alter *    GetUserData () alter                                { return m_data;            }
		/*! Returns the size of the data buffer */
		int             GetSize () const                                    { return m_size;            }
...
class BBINFILETK_API TK_XML : public BBaseOpcodeHandler {
	...
	public:
		...
		*/
		...
		/*! Returns the address of the data buffer, which may be modified directly */
		char alter *    GetXML () alter                     { return m_data;            }
		/*! Returns the size of the data buffer */
		int             GetSize () const                    { return m_size;            }
};
...
class BBINFILETK_API TK_External_Reference_Unicode : public BBaseOpcodeHandler {
	...
	public:
		...
		/*! Returns the reference string buffer, which may be modified directly */
		wchar_t alter *    GetString () alter                  { return m_string;      }
};
