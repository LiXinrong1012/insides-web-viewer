...
// manner of such use.
//
// $Header: /files/homes/master/cvs/hoops_master/shared/stream_common/BAscii.cpp,v 1.78 2010-10-22 19:24:17 trask Exp $
//
...
TK_Status TK_Geometry_Options::WriteAscii (BStreamFileToolkit & tk) alter {
#ifndef BSTREAM_DISABLE_ASCII
    ...
    switch (m_stage) {
        ...
        case 1: {
            ...
            if ((status = PutAsciiHex (tk,"Mask",m_mask)) != TK_Normal)
                return status;
            m_stage++;
        }   nobreak;
        ...
        case 2: {
            ...
            if ((m_mask & TKO_Geometry_Options_Orientation)) {
                if ((status = PutAsciiHex (tk, "Orientation_Count", m_orientation_count)) != TK_Normal)
                    return status;
            }
            m_stage++;
        }   nobreak;
        ...
        case 3: {
            if ((m_mask & TKO_Geometry_Options_Orientation)) {
				if ((status = PutAsciiData (tk,"Orientation", m_orientation, m_orientation_count)) != TK_Normal)
					return status;
			}
			m_stage = -1;
        }   break;
...
TK_Status TK_Geometry_Options::ReadAscii (BStreamFileToolkit & tk) alter {
#ifndef BSTREAM_DISABLE_ASCII
	...
	switch (m_stage) {
        ...
        case 1: {
            if (m_mask & TKO_Geometry_Options_Orientation) {
				if ((status = GetAsciiHex (tk,"Orientation_Count", m_orientation_count)) != TK_Normal)
                    return status;
            }
            m_stage++;
        }   nobreak;
        ...
        case 2: {
            if ((m_mask & TKO_Geometry_Options_Orientation)) {
				if ((status = GetAsciiData (tk,"Orientation", m_orientation, m_orientation_count)) != TK_Normal)
					return status;
			}
			m_stage = -1;
		}   break;
...
TK_Status TK_Conditional_Action::WriteAscii (BStreamFileToolkit & tk) alter {
#ifndef BSTREAM_DISABLE_ASCII
    ...
    if (tk.GetTargetVersion() < 1824)   // skip, not supported
        return status;
    ...
    switch (m_stage) {
        ...
        case 1: {
            if ((status = PutAsciiData (tk,"Action_Type", (int) m_type)) != TK_Normal)
                return status;
            m_stage++;
        }   nobreak;
...
TK_Status TK_Conditional_Action::ReadAscii (BStreamFileToolkit & tk) alter {
#ifndef BSTREAM_DISABLE_ASCII
    ...
    switch (m_stage) {
        case 0: {
			int		dword;
            if ((status = GetAsciiData (tk,"Action_Type", dword)) != TK_Normal)
                return status;
			m_type = (short)dword;
            m_stage++;
        }   nobreak;
        ...
        case 1: {
			int		dword;
            if ((status = GetAsciiData (tk,"Options", dword)) != TK_Normal)
                return status;
			m_options = (short)dword;
            m_stage++;
        }   nobreak;
...
TK_Status TK_Named_Style_Def::WriteAscii (BStreamFileToolkit & tk) alter {
#ifndef BSTREAM_DISABLE_ASCII
...
TK_Status TK_Named_Style_Def::ReadAscii (BStreamFileToolkit & tk) alter {
#ifndef BSTREAM_DISABLE_ASCII
	UNREFERENCED(tk);
