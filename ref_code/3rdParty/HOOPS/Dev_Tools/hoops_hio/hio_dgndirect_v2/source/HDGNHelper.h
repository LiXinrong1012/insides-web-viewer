...
// manner of such use.
//
// $Header: /files/homes/master/cvs/hoops_master/hio_dgndirect_v2/source/HDGNHelper.h,v 1.34 2010-10-29 08:30:25 vinit Exp $
//
...
public:
	...
	inline void OdGePoint2d_2_HPoint(const OdGePoint2d* odg_point, HPoint& h_point)
	{
		...
		{
			h_point.x = (odg_point->x) - m_dMinX;
			h_point.y = (odg_point->y) - m_dMinY;
			h_point.z = 0.0f;
		}
		else 
		{
	...
	bool getLevelName( OdDgGraphicsElementPtr grElm, char*& level_name );
...
protected:
	...
	static VHash<int,char*> m_hashLevelIDName;
