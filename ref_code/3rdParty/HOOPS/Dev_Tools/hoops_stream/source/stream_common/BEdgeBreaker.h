 ...
 * manner of such use.
 *
 * $Header: /files/homes/master/cvs/hoops_master/shared/stream_common/BEdgeBreaker.h,v 1.29 2008-10-27 22:19:06 heppe Exp $
 *
 *
 *
 * HEdgeBreaker.h
...
#define HPREV(i) (3*((i)/3) + ((i)+2)%3)
    ...
    /* 
     * External function declarations (functions from HEdgeBreakerCommon.cpp)
     */
