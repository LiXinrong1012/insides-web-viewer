...
// manner of such use.
//
// $Header: /files/homes/master/cvs/hoops_master/shared/stream_common/BStreamFileToolkit.h,v 1.176 2010-10-26 20:24:38 heppe Exp $
//
...
class BBINFILETK_API2 Internal_Data_Accumulator {
    ...
    public:
        ...
        TK_Status   start_compression () alter;
        TK_Status   stop_compression (bool flush) alter;
        TK_Status   start_decompression () alter;
...
class Internal_ExRef_List : public BControlledMemoryObject {
    ...
    public:
        ...
        __wchar_t const *	Reference () const { return m_ref; }
        __wchar_t const *	Actual () const { return m_actual; }
        ID_Key			Context () const { return m_context; }
		Internal_ExRef_List *	Caller () const { return m_caller; }
		void			SetActual (__wchar_t const * actual) alter;
#ifdef _MSC_VER
		void			SetActual (unsigned short const * actual) alter;
#endif
};
...
class BBINFILETK_API2 BStreamFileToolkit : public BControlledMemoryObject {
    ...
    protected:
        ...
        __wchar_t **						m_file_names;           /*!< array of associated Unicode filenames processed by the toolkit in this run */
        ...
        __wchar_t *						m_current_filename;     /*!< current (last) filenames entry */
        ...
        __wchar_t *						m_wfilename;            /*!< Unicode name of file to process */
    ...
    public:
        ...
        */
        TK_Status   GetOffset (ID_Key key, int variant,
                               int alter & offset, int alter & length, __wchar_t const * alter & filename) const;
#ifdef _MSC_VER
        TK_Status   GetOffset (ID_Key key, int variant,
                               int alter & offset, int alter & length, unsigned short const * alter & filename) const;
#endif
        /*! 
        ...
        */
        int         NextTagIndex () alter   { return m_tag_count++; }
        /*! 
...
#ifdef _MSC_VER
		void            SetNewFile (unsigned short const * name) alter;
#endif
		/*!
...
#ifdef _MSC_VER
		TK_Status       SelectFile (unsigned short const * name) alter;
#endif
        /*!
	...
	/*! Sets the number of bits per sample for vertex parameters (texture coordinates).  For backwards compatibility it is specified
		...
		*/
        void        SetTargetVersion (int version) alter     { m_target_version = version; }  
        ...
        void        CloseLogFile () alter;
                ...
                /*! internal use */
        unsigned int    NextOpcodeSequence () alter                 { return ++m_opcode_sequence;   }
                /*! internal use */
        ...
        */
        void        ClearPauses () alter				{ m_num_pauses = 0;     }
        /*!
...
#ifdef _MSC_VER
        bool        AddExternalReference (unsigned short const * ref, ID_Key context) alter;
#endif
        ...
        */
        __wchar_t const *GetExternalReference () const {
                            return  (m_external_references != 0) ? (__wchar_t const*)m_external_references->Reference() : 0;
                        }
        ...
        */
        ID_Key      CurrentSegment () alter { return (m_active_segments != 0) ? m_active_segments->key() : -1; }
    ...
    protected:
        ...
        ID_Key      remove_segment () alter { return RemoveSegment(); }
        ...
        void        mark_position () alter      { set_position (GeneratedSoFar()); }
        ...
        */
        ...
        // utility
        TK_Status   start_compression () alter      { return m_accumulator.start_compression(); }
        TK_Status   stop_compression () alter       { return m_accumulator.stop_compression(true); }
        TK_Status   start_decompression () alter                { return m_accumulator.start_decompression(); }
        TK_Status   stop_decompression (bool force = false) alter   { return m_accumulator.stop_decompression(force); }
        virtual void    empty_lists () alter;
