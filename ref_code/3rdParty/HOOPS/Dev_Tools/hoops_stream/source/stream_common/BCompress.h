...
// manner of such use.
//
// $Header: /files/homes/master/cvs/hoops_master/shared/stream_common/BCompress.h,v 1.17 2009-02-28 03:02:42 covey Exp $
//
...
/* various identifiers for compression schemes */
#define CS_INVALID                      0
#define CS_TRIVIAL                      1
...
// an overloaded variant of the above that omits the exists_in and mask_in
extern TK_Status quantize_and_pack_floats ( 
        BStreamFileToolkit & tk,
        int count_in,
	int size_in,
...
// in TKSH_BOUNDING_ONLY mode, the shell always has the same face list and tristrips
extern const int bounding_faces[30];
extern const int bounding_tristrips[19];
extern const float color_cube[6];
extern const float rgba_cube[8];
