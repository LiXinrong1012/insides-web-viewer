...
// manner of such use.
//
// $Header: /files/homes/master/cvs/hoops_master/hoops_stream/source/HStreamFileToolkit.h,v 1.112 2010-10-22 19:24:17 trask Exp $
//
...
class HBINFILETK_API2 Internal_Segment_Processor : public BBaseOpcodeHandler {
    protected:
		...
		long					m_priority;			/*!< priority of a subsegment */
		...
		bool					m_geometry_attributes;	/*!< a flag to indicate there are attributes attached to a geometry */
...
class HBINFILETK_API2 HStreamFileToolkit : public BStreamFileToolkit {
    ...
    public:
		...
		*/
		void		AddExcludedSegment (HC_KEY key) alter	{ AddExcludedSegments (1, &key);	}
		/*!
    ...
    protected:
        ...
        //! internal use
        void            empty_lists () alter;
        //! internal use
        TK_Status       tag (int variant) alter;
        //! internal use
        unsigned HLONG   count_segment_objects (HC_KEY key, char const * start_segment = 0) alter;
};
