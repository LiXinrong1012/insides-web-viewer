...
// manner of such use.
//
// $Header: /files/homes/master/cvs/hoops_master/hoops_stream/source/HOpcodeHandler.h,v 1.158 2010-09-09 02:08:47 covey Exp $
//
...
class HBINFILETK_API HTK_Enumerated : public TK_Enumerated {
    public:
        ...
        TK_Status   Execute (BStreamFileToolkit & tk) alter;
        TK_Status   Interpret (BStreamFileToolkit & tk, ID_Key key=-1, int variant=0) alter;
        TK_Status   Interpret (BStreamFileToolkit & tk, ID_Key key, char const * special) alter
...
/*! local texture definitions, contains a list of simple textures which can actually be written.
    reading will just interpret the simple objects directly, as usual */
