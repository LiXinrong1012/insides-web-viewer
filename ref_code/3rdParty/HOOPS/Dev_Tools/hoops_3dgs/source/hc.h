...
HC_EXTERNAL void HC_CDECL HC_Compute_Cross_Product (
		const HC_POINT * vector1, const HC_POINT * vector2, HC_POINT * out_vector);
HC_EXTERNAL double HC_CDECL HC_Compute_Dot_Product (
		const HC_POINT * vector1, const HC_POINT * vector2);
HC_EXTERNAL void HC_CDECL HC_Compute_Face_Neighborhood (
		HC_KEY key, int index, int * count, int * neighbors);
HC_EXTERNAL void HC_CDECL HC_Compute_Face_Neighborhood_Si (
		HC_KEY key, int index, int * count);
#define HC_Compute_Face_Neighborhood_Size(key, index, count) \
		HC_Compute_Face_Neighborhood_Si(key, index, count)
HC_EXTERNAL void HC_CDECL HC_Compute_Identity_Matrix (
		float * out_matrix);
HC_EXTERNAL int HC_CDECL HC_Compute_Intersect_Polyline (
		int point_count1, const HC_POINT * points1, int face_list_length1, const int * face_list1, int point_count2, const HC_POINT * points2, int face_list_length2, const int * face_list2, int * polyline_count, int * polyline_lengths, int * polyline_points_count, HC_POINT * polyline_points);
...
HC_EXTERNAL HC_BOOLEAN HC_CDECL HC_Compute_Normalized_Vector (
		const HC_POINT * vector, HC_POINT * out_vector);
...
HC_EXTERNAL HC_BOOLEAN HC_CDECL HC_Compute_Point_Inside_Shell (
		const HC_POINT * pt, int point_count1, const HC_POINT * points1, int face_list_length1, const int * face_list1);
HC_EXTERNAL HC_BOOLEAN HC_CDECL HC_Compute_Point_On_Shell (
		const HC_POINT * pt, double tolerance, int point_count1, const HC_POINT * points1, int face_list_length1, const int * face_list1);
...
HC_EXTERNAL int HC_CDECL HC_Compute_Points_Distance_F_Sh (
		int test_pcount, const HC_POINT * test_pt, double tolerance, int point_count1, const HC_POINT * points1, int face_list_length1, const int * face_list1, const char * options, float * results);
#define HC_Compute_Points_Distance_From_Shell(test_pcount, test_pt, tolerance, point_count1, points1, face_list_length1, face_list1, options, results) \
		HC_Compute_Points_Distance_F_Sh(test_pcount, test_pt, tolerance, point_count1, points1, face_list_length1, face_list1, options, results)
HC_EXTERNAL void HC_CDECL HC_Compute_Points_Inside_Shell (
		int test_pcount, const HC_POINT * test_pt, const HC_POINT * test_vec, int point_count1, const HC_POINT * points1, int face_list_length1, const int * face_list1, const char * options, int * results);
HC_EXTERNAL int HC_CDECL HC_Compute_Points_On_Shell (
		int test_pcount, const HC_POINT * test_pt, double tolerance, int point_count1, const HC_POINT * points1, int face_list_length1, const int * face_list1, int * results);
HC_EXTERNAL HC_BOOLEAN HC_CDECL HC_Compute_Polygon_Normal (
		int count, const HC_POINT * points, const char * hand, HC_POINT * out_vector);
...
HC_EXTERNAL void HC_CDECL HC_Compute_Polyline_From_Curve (
...
HC_EXTERNAL void HC_CDECL HC_Compute_Screen_Extent (
		const char * segname, const char * filter, float * left, float * right, float * bottom, float * top);
HC_EXTERNAL void HC_CDECL HC_Compute_Screen_Extent_By_Key (
		HC_KEY key, const char * filter, float * left, float * right, float * bottom, float * top);
HC_EXTERNAL void HC_CDECL HC_Compute_Screen_Extent_By_Pat (
		int count, const HC_KEY * keys, const char * filter, float * left, float * right, float * bottom, float * top);
#define HC_Compute_Screen_Extent_By_Path(count, keys, filter, left, right, bottom, top) \
		HC_Compute_Screen_Extent_By_Pat(count, keys, filter, left, right, bottom, top)
...
HC_EXTERNAL int HC_CDECL HC_Compute_Selection_By_Key (
		const char * action, const char * start_seg, HC_KEY key, const float * mat);
...
HC_EXTERNAL int HC_CDECL HC_Compute_Selection_By_Ray (
		const char * action, const char * start_seg, const HC_POINT * start, const HC_POINT * direction);
...
HC_EXTERNAL int HC_CDECL HC_Compute_Selection_By_Swept_S (
		const char * action, const char * start_seg, HC_KEY shellkey, int sweepcount, const float * matrices, const char * options);
#define HC_Compute_Selection_By_Swept_Shell(action, start_seg, shellkey, sweepcount, matrices, options) \
		HC_Compute_Selection_By_Swept_S(action, start_seg, shellkey, sweepcount, matrices, options)
...
HC_EXTERNAL float HC_CDECL HC_Compute_Selection_Dist_By_Sh (
		const char * action, const char * start_seg, int point_count, const HC_POINT * points, int face_list_length, const int * face_list, const char * options);
#define HC_Compute_Selection_Distance_By_Shell(action, start_seg, point_count, points, face_list_length, face_list, options) \
		HC_Compute_Selection_Dist_By_Sh(action, start_seg, point_count, points, face_list_length, face_list, options)
...
HC_EXTERNAL HC_KEY HC_CDECL HC_Compute_Swept_Shell (
		HC_KEY shellkey, const HC_POINT * direction_in, HC_KEY * front_key, HC_KEY * back_key, HC_KEY * side_key, const char * options);
HC_EXTERNAL void HC_CDECL HC_Compute_Swept_Shell_Along_P (
		HC_KEY shellkey, int numsweeps, const float * matrices, const char * options);
#define HC_Compute_Swept_Shell_Along_Path(shellkey, numsweeps, matrices, options) \
		HC_Compute_Swept_Shell_Along_P(shellkey, numsweeps, matrices, options)
...
HC_EXTERNAL void HC_CDECL HC_Compute_Text_Extent (
		const char * segment, const char * text, float * size, float * ysize);
HC_EXTERNAL void HC_CDECL HC_Compute_Text_Extent_By_Key (
		HC_KEY key, float * xfrac, float * yfrac);
HC_EXTERNAL void HC_CDECL HC_Compute_Text_Extent_By_Path (
		int count, const HC_KEY * keys, const char * text, float * xfrac, float * yfrac);
HC_EXTERNAL void HC_CDECL HC_Compute_Text_Extent_Enc_Path (
		int count, const HC_KEY * keys, const char * encoding, const char * text, float * xfrac, float * yfrac);
HC_EXTERNAL void HC_CDECL HC_Compute_Text_Extent_With_Enc (
		const char * segment, const char * encoding, const char * text, float * xfrac, float * yfrac);
...
HC_EXTERNAL double HC_CDECL HC_Compute_Vector_Angle (
		const HC_POINT * in1, const HC_POINT * in2);
...
HC_EXTERNAL HC_KEY HC_CDECL HC_Conditional_Include_By_Key (
		HC_KEY key, const char * condition);
...
HC_EXTERNAL HC_KEY HC_CDECL HC_Copy_Segment (
		const char * old, const char * nNew);
HC_EXTERNAL HC_KEY HC_CDECL HC_Copy_Segment_With_Mapping (
		const char * oldname, const char * newname, int count, const HC_KEY * old_keys, HC_KEY * new_keys);
...
HC_EXTERNAL void HC_CDECL HC_Define_Named_Style (
		const char * style_name, const char * style_segment_name);
...
HC_EXTERNAL void HC_CDECL HC_Edit_Circle_By_Radius (
		HC_KEY key, const HC_POINT * center, double radius, const HC_POINT * vector);
...
HC_EXTERNAL void HC_CDECL HC_Edit_NURBS_Curve (
		HC_KEY key, int control_point_offset, int knot_offset, int control_point_replace_count, int knot_replace_count, const HC_POINT * control_points, const float * weights, const float * knots);
HC_EXTERNAL void HC_CDECL HC_Edit_NURBS_Surface (
		HC_KEY key, int control_point_offset, int weight_offset, int u_knot_offset, int v_knot_offset, int control_point_replace_count, int weight_replace_count, int u_knot_replace_count, int v_knot_replace_count, const HC_POINT * control_points, const float * weights, const float * u_knots, const float * v_knots);
...
HC_EXTERNAL void HC_CDECL HC_Edit_NURBS_Surface_Points (
		HC_KEY key, int control_point_offset, int control_point_replace_count, const HC_POINT * control_points);
HC_EXTERNAL void HC_CDECL HC_Edit_NURBS_Surface_Weights (
		HC_KEY key, int weight_offset, int weight_replace_count, const float * control_points);
...
HC_EXTERNAL void HC_CDECL HC_Edit_Sphere (
		HC_KEY key, const HC_POINT * center, double radius, const HC_POINT * axis, const HC_POINT * ortho);
...
HC_EXTERNAL HC_BOOLEAN HC_CDECL HC_Filter_Circumcuboid (
		const char * segname, const char * filter, HC_POINT * min, HC_POINT * max);
HC_EXTERNAL HC_BOOLEAN HC_CDECL HC_Filter_Circumcuboid_By_Key (
		HC_KEY key, const char * filter, HC_POINT * min, HC_POINT * max);
HC_EXTERNAL HC_BOOLEAN HC_CDECL HC_Filter_Circumsphere (
		const char * segname, const char * filter, HC_POINT * center, float * radius);
HC_EXTERNAL HC_BOOLEAN HC_CDECL HC_Filter_Circumsphere_By_Key (
		HC_KEY key, const char * filter, HC_POINT * center, float * radius);
...
HC_EXTERNAL HC_BOOLEAN HC_CDECL HC_Find_Color_Name (
		char * color, char * er_name, char * ish_name);
...
HC_EXTERNAL HC_BOOLEAN HC_CDECL HC_Find_Error_Handler (
		void (HC_CDECL ** address)(HC_ANY_ARGS));
...
HC_EXTERNAL HC_KEY HC_CDECL HC_Insert_Circle_By_Radius (
		const HC_POINT * center, double radius, const HC_POINT * normal);
...
HC_EXTERNAL HC_KEY HC_CDECL HC_Insert_Cylinder (
		const HC_POINT * center_point1, const HC_POINT * center_point2, double radius, const char * cap);
...
HC_EXTERNAL HC_KEY HC_CDECL HC_Insert_NURBS_Curve (
		int degree, int control_point_count, const HC_POINT * control_points, const float * weights, const float * knots, double start_u, double end_u);
HC_EXTERNAL HC_KEY HC_CDECL HC_Insert_NURBS_Surface (
		int u_degree, int v_degree, int n_u_vertices, int n_v_vertices, const HC_POINT * control_points, const float * weights, const float * u_knots, const float * v_knots);
HC_EXTERNAL HC_KEY HC_CDECL HC_Insert_PolyCylinder (
		int pcount, const HC_POINT * pts, int rcount, const float * rads, const char * listptr);
...
HC_EXTERNAL HC_KEY HC_CDECL HC_Insert_Shell_From_Region (
		HC_KEY key, int region, const char * options);
HC_EXTERNAL HC_KEY HC_CDECL HC_Insert_Sphere (
		const HC_POINT * center, double radius, const HC_POINT * axis, const HC_POINT * ortho);
...
HC_EXTERNAL void HC_CDECL HC_MSet_Face_Regions (
		HC_KEY key, int first, int count, const int * in_regions);
HC_EXTERNAL void HC_CDECL HC_MSet_Face_Visibilities (
		HC_KEY key, int offset, int count, const char * visibilities);
HC_EXTERNAL void HC_CDECL HC_MSet_Region_Faces (
		HC_KEY key, int region, int first, int count);
...
HC_EXTERNAL void HC_CDECL HC_MSet_Spec_Vert_Col_By_FIndex (
		HC_KEY key, const char * geometry, int count, const int * indices, const float * findices);
#define HC_MSet_Specific_Vertex_Colors_By_FIndex(key, geometry, count, indices, findices) \
		HC_MSet_Spec_Vert_Col_By_FIndex(key, geometry, count, indices, findices)
HC_EXTERNAL void HC_CDECL HC_MSet_Spec_Vert_Col_By_Value (
		HC_KEY key, const char * geometry, int count, const int * indices, const char * color_space, const HC_RGB * values);
#define HC_MSet_Specific_Vertex_Colors_By_Value(key, geometry, count, indices, color_space, values) \
		HC_MSet_Spec_Vert_Col_By_Value(key, geometry, count, indices, color_space, values)
...
HC_EXTERNAL void HC_CDECL HC_MSet_Specific_Edge_Vis (
		HC_KEY key, int count, const int * indices1, const int * indices2, const char * visibilities);
#define HC_MSet_Specific_Edge_Visibilities(key, count, indices1, indices2, visibilities) \
		HC_MSet_Specific_Edge_Vis(key, count, indices1, indices2, visibilities)
...
HC_EXTERNAL void HC_CDECL HC_MSet_Specific_Face_Vis (
		HC_KEY key, int count, const int * indices, const char * visibilities);
#define HC_MSet_Specific_Face_Visibilities(key, count, indices, visibilities) \
		HC_MSet_Specific_Face_Vis(key, count, indices, visibilities)
#define HC_MSet_Face_Visibilities_By_Index(key, count, indices, visibilities) \
		HC_MSet_Specific_Face_Vis(key, count, indices, visibilities)
HC_EXTERNAL void HC_CDECL HC_MSet_Specific_Vertex_Normals (
		HC_KEY key, int count, const int * indices, const HC_VECTOR * normals);
HC_EXTERNAL void HC_CDECL HC_MSet_Specific_Vertex_Vis (
		HC_KEY key, int count, const int * indices, const char * visibilities);
#define HC_MSet_Specific_Vertex_Visibilities(key, count, indices, visibilities) \
		HC_MSet_Specific_Vertex_Vis(key, count, indices, visibilities)
...
HC_EXTERNAL void HC_CDECL HC_MShow_Character_Attributes (
		HC_KEY key, int offset, int count, char * result);
...
HC_EXTERNAL void HC_CDECL HC_MShow_Face_Regions (
		HC_KEY key, int * count, int * regions);
...
HC_EXTERNAL void HC_CDECL HC_MShow_Face_Visibilities (
		HC_KEY key, int offset, int count, char * visibilities);
...
HC_EXTERNAL void HC_CDECL HC_MShow_Partial_Face_Regions (
		HC_KEY key, int first, int count, int * regions);
HC_EXTERNAL void HC_CDECL HC_MShow_Region_Faces (
		HC_KEY key, int region, int * count, int * faces);
HC_EXTERNAL void HC_CDECL HC_MShow_Region_Faces_Count (
		HC_KEY key, int region, int * count);
...
HC_EXTERNAL void HC_CDECL HC_MShow_Spec_Vert_Col_By_FInd (
		HC_KEY key, const char * geometry, int count, const int * indices, float * findices);
#define HC_MShow_Specific_Vertex_Colors_By_FIndex(key, geometry, count, indices, findices) \
		HC_MShow_Spec_Vert_Col_By_FInd(key, geometry, count, indices, findices)
HC_EXTERNAL void HC_CDECL HC_MShow_Spec_Vert_Col_By_Value (
		HC_KEY key, const char * geometry, int count, const int * indices, HC_RGB * rgb);
#define HC_MShow_Specific_Vertex_Colors_By_Value(key, geometry, count, indices, rgb) \
		HC_MShow_Spec_Vert_Col_By_Value(key, geometry, count, indices, rgb)
...
HC_EXTERNAL void HC_CDECL HC_MShow_Specific_Edge_Vis (
		HC_KEY key, int count, const int * indices1, const int * indices2, char * visibilities);
#define HC_MShow_Specific_Edge_Visibilities(key, count, indices1, indices2, visibilities) \
		HC_MShow_Specific_Edge_Vis(key, count, indices1, indices2, visibilities)
...
HC_EXTERNAL void HC_CDECL HC_MShow_Specific_Face_Vis (
		HC_KEY key, int count, const int * indices, char * visibilities);
#define HC_MShow_Specific_Face_Visibilities(key, count, indices, visibilities) \
		HC_MShow_Specific_Face_Vis(key, count, indices, visibilities)
#define HC_MShow_Face_Visibilities_By_Index(key, count, indices, visibilities) \
		HC_MShow_Specific_Face_Vis(key, count, indices, visibilities)
...
HC_EXTERNAL void HC_CDECL HC_MShow_Specific_Vertex_Vis (
		HC_KEY key, int count, const int * indices, char * visibilities);
#define HC_MShow_Specific_Vertex_Visibilities(key, count, indices, visibilities) \
		HC_MShow_Specific_Vertex_Vis(key, count, indices, visibilities)
HC_EXTERNAL void HC_CDECL HC_MShow_Vertex_Colors_By_FInd (
		HC_KEY key, const char * type, int offset, int count, float * findices);
#define HC_MShow_Vertex_Colors_By_FIndex(key, type, offset, count, findices) \
		HC_MShow_Vertex_Colors_By_FInd(key, type, offset, count, findices)
...
HC_EXTERNAL void HC_CDECL HC_MShow_Vertex_Parameter_Size (
		HC_KEY key, int * number_parameters);
HC_EXTERNAL void HC_CDECL HC_MShow_Vertex_Parameters (
		HC_KEY key, int offset, int count, int * number_parameters, float * user_parameters);
...
HC_EXTERNAL void HC_CDECL HC_MUnSet_Spec_Face_Colors (
		HC_KEY key, int count, const int * indices);
#define HC_MUnSet_Specific_Face_Colors(key, count, indices) \
		HC_MUnSet_Spec_Face_Colors(key, count, indices)
...
HC_EXTERNAL void HC_CDECL HC_MUnSet_Spec_Vertex_Colors (
		HC_KEY key, int count, const int * indices);
#define HC_MUnSet_Specific_Vertex_Colors(key, count, indices) \
		HC_MUnSet_Spec_Vertex_Colors(key, count, indices)
...
HC_EXTERNAL void HC_CDECL HC_Move_By_Key (
		HC_KEY key, const char * new_owner);
...
HC_EXTERNAL void HC_CDECL HC_PShow_Net_Callback (
		int key_count, const HC_KEY * path_keys, char * callbacks);
HC_EXTERNAL void HC_CDECL HC_PShow_Net_Camera (
...
HC_EXTERNAL void HC_CDECL HC_PShow_Net_Camera_By_Volume (
		int count, const HC_KEY * keys, char * proj, float * xmin, float * xmax, float * ymin, float * ymax);
HC_EXTERNAL void HC_CDECL HC_PShow_Net_Camera_Field (
...
HC_EXTERNAL void HC_CDECL HC_PShow_Net_Camera_Position (
		int key_count, const HC_KEY * path_keys, float * x, float * y, float * z);
HC_EXTERNAL void HC_CDECL HC_PShow_Net_Camera_Projection (
		int key_count, const HC_KEY * path_keys, char * projection);
HC_EXTERNAL void HC_CDECL HC_PShow_Net_Camera_Target (
		int key_count, const HC_KEY * path_keys, float * x, float * y, float * z);
HC_EXTERNAL void HC_CDECL HC_PShow_Net_Camera_Up_Vector (
		int key_count, const HC_KEY * path_keys, float * x, float * y, float * z);
HC_EXTERNAL void HC_CDECL HC_PShow_Net_Clip_Region (
		int count, const HC_KEY * keys, int * loops, int * lengths, HC_POINT * points, char * spec);
HC_EXTERNAL void HC_CDECL HC_PShow_Net_Clip_Region_Size (
		int count, const HC_KEY * keys, int * loops, int * total, char * spec);
HC_EXTERNAL void HC_CDECL HC_PShow_Net_Color (
		int count, const HC_KEY * keys, char * color_spec);
HC_EXTERNAL void HC_CDECL HC_PShow_Net_Color_Map (
		int key_count, const HC_KEY * path_keys, char * colors);
HC_EXTERNAL void HC_CDECL HC_PShow_Net_Color_Map_By_Value (
		int key_count, const HC_KEY * path_keys, char * color_space, int * count, HC_RGB * values);
HC_EXTERNAL void HC_CDECL HC_PShow_Net_Color_Map_Count (
		int key_count, const HC_KEY * path_keys, int * count);
HC_EXTERNAL void HC_CDECL HC_PShow_Net_Color_Map_Length (
		int count, const HC_KEY * keys, int * value);
HC_EXTERNAL void HC_CDECL HC_PShow_Net_Conditions (
		int count, const HC_KEY * keys, char * options);
HC_EXTERNAL void HC_CDECL HC_PShow_Net_Conditions_Length (
		int count, const HC_KEY * keys, int * length);
HC_EXTERNAL void HC_CDECL HC_PShow_Net_Driver_Options (
		int key_count, const HC_KEY * path_keys, char * list);
HC_EXTERNAL void HC_CDECL HC_PShow_Net_Edge_Pattern (
		int key_count, const HC_KEY * path_keys, char * pattern);
HC_EXTERNAL void HC_CDECL HC_PShow_Net_Edge_Pattern_Exp (
...
HC_EXTERNAL void HC_CDECL HC_PShow_Net_Edge_Weight (
		int key_count, const HC_KEY * path_keys, float * weight);
HC_EXTERNAL void HC_CDECL HC_PShow_Net_Explicit_Color (
		int keycount, const HC_KEY * path_keys, const char * type, const char * channel, float * rgb, char * texture, char * options);
HC_EXTERNAL void HC_CDECL HC_PShow_Net_Face_Pattern (
		int key_count, const HC_KEY * path_keys, char * pattern);
HC_EXTERNAL void HC_CDECL HC_PShow_Net_Glyph (
		int count, const HC_KEY * keys, const char * name, char * definition);
HC_EXTERNAL void HC_CDECL HC_PShow_Net_Glyph_Size (
		int count, const HC_KEY * keys, const char * name, int * size);
HC_EXTERNAL void HC_CDECL HC_PShow_Net_Handedness (
		int key_count, const HC_KEY * path_keys, char * value);
HC_EXTERNAL void HC_CDECL HC_PShow_Net_Heuristics (
		int key_count, const HC_KEY * path_keys, char * list);
HC_EXTERNAL void HC_CDECL HC_PShow_Net_Line_Pattern (
		int key_count, const HC_KEY * path_keys, char * pattern);
HC_EXTERNAL void HC_CDECL HC_PShow_Net_Line_Pattern_Exp (
		int count, const HC_KEY * keys, char * pattern);
#define HC_PShow_Net_Line_Pattern_Explicit(count, keys, pattern) \
		HC_PShow_Net_Line_Pattern_Exp(count, keys, pattern)
HC_EXTERNAL void HC_CDECL HC_PShow_Net_Line_Style (
		int count, const HC_KEY * keys, const char * name, char * definition);
HC_EXTERNAL void HC_CDECL HC_PShow_Net_Line_Style_Size (
		int count, const HC_KEY * keys, const char * name, int * size);
HC_EXTERNAL void HC_CDECL HC_PShow_Net_Line_Weight (
		int key_count, const HC_KEY * path_keys, float * weight);
HC_EXTERNAL void HC_CDECL HC_PShow_Net_Marker_Size (
		int key_count, const HC_KEY * path_keys, float * size);
HC_EXTERNAL void HC_CDECL HC_PShow_Net_Marker_Symbol (
		int key_count, const HC_KEY * path_keys, char * symbol);
HC_EXTERNAL void HC_CDECL HC_PShow_Net_Modelling_Matrix (
		int key_count, const HC_KEY * path_keys, float * matrix);
HC_EXTERNAL HC_KEY HC_CDECL HC_PShow_Net_Named_Style (
		int count, const HC_KEY * keys, const char * style_name, char * style_segment_name);
HC_EXTERNAL void HC_CDECL HC_PShow_Net_Rendering_Options (
		int key_count, const HC_KEY * path_keys, char * list);
HC_EXTERNAL void HC_CDECL HC_PShow_Net_Selectability (
		int key_count, const HC_KEY * path_keys, char * list);
HC_EXTERNAL void HC_CDECL HC_PShow_Net_Shader (
		int count, const HC_KEY * keys, const char * name, char * output, char * shader_source);
HC_EXTERNAL void HC_CDECL HC_PShow_Net_Text_Alignment (
		int key_count, const HC_KEY * path_keys, char * locater);
HC_EXTERNAL void HC_CDECL HC_PShow_Net_Text_Font (
		int key_count, const HC_KEY * path_keys, char * options);
HC_EXTERNAL void HC_CDECL HC_PShow_Net_Text_Path (
		int key_count, const HC_KEY * path_keys, float * x, float * y, float * z);
HC_EXTERNAL void HC_CDECL HC_PShow_Net_Text_Spacing (
		int key_count, const HC_KEY * path_keys, float * spacing);
HC_EXTERNAL void HC_CDECL HC_PShow_Net_Texture (
		int count, const HC_KEY * keys, const char * txr, char * output, HC_KEY * out_image);
HC_EXTERNAL void HC_CDECL HC_PShow_Net_Texture_Matrix (
		int key_count, const HC_KEY * path_keys, float * matrix);
HC_EXTERNAL void HC_CDECL HC_PShow_Net_Unicode_Opt_Length (
...
HC_EXTERNAL void HC_CDECL HC_PShow_Net_Unicode_Options (
		int key_count, const HC_KEY * path_keys, unsigned short * options);
HC_EXTERNAL void HC_CDECL HC_PShow_Net_User_Index_Count (
		int key_count, const HC_KEY * keys, int * count);
HC_EXTERNAL void HC_CDECL HC_PShow_Net_User_Indices (
		int key_count, const HC_KEY * path_keys, int * count, long * indices, void * values);
HC_EXTERNAL void HC_CDECL HC_PShow_Net_User_Opt_Length (
		int key_count, const HC_KEY * path_keys, int * length);
...
HC_EXTERNAL void HC_CDECL HC_PShow_Net_User_Options (
		int key_count, const HC_KEY * path_keys, char * list);
HC_EXTERNAL void HC_CDECL HC_PShow_Net_User_Value (
		int key_count, const HC_KEY * path_keys, HC_POINTER_SIZED_INT * data);
HC_EXTERNAL void HC_CDECL HC_PShow_Net_Var_Edge_Weight (
...
HC_EXTERNAL void HC_CDECL HC_PShow_Net_Var_Line_Weight (
		int count, const HC_KEY * keys, char * weight);
#define HC_PShow_Net_Variable_Line_Weight(count, keys, weight) \
		HC_PShow_Net_Var_Line_Weight(count, keys, weight)
HC_EXTERNAL void HC_CDECL HC_PShow_Net_Var_Marker_Size (
...
HC_EXTERNAL void HC_CDECL HC_PShow_Net_Visibility (
		int key_count, const HC_KEY * path_keys, char * list);
HC_EXTERNAL void HC_CDECL HC_PShow_Net_Window (
		int key_count, const HC_KEY * path_keys, float * left, float * right, float * bottom, float * top);
HC_EXTERNAL void HC_CDECL HC_PShow_Net_Window_Frame (
		int key_count, const HC_KEY * path_keys, char * flag);
HC_EXTERNAL void HC_CDECL HC_PShow_Net_Window_Pattern (
		int key_count, const HC_KEY * path_keys, char * pattern);
...
HC_EXTERNAL void HC_CDECL HC_PShow_One_Net_Callback_WD (
...
HC_EXTERNAL void HC_CDECL HC_PShow_One_Net_Color (
		int count, const HC_KEY * keys, const char * type, char * color);
HC_EXTERNAL void HC_CDECL HC_PShow_One_Net_Color_By_Index (
		int count, const HC_KEY * keys, const char * type, int * index);
HC_EXTERNAL void HC_CDECL HC_PShow_One_Net_Color_By_Value (
		int count, const HC_KEY * keys, const char * type, char * color_space, float * a, float * b, float * c);
HC_EXTERNAL void HC_CDECL HC_PShow_One_Net_Color_Map (
		int count, const HC_KEY * keys, int offset, char * color);
HC_EXTERNAL void HC_CDECL HC_PShow_One_Net_Color_Map_By_V (
...
HC_EXTERNAL void HC_CDECL HC_PShow_One_Net_Condition (
		int count, const HC_KEY * keys, const char * conditions, char * options);
HC_EXTERNAL void HC_CDECL HC_PShow_One_Net_Driver_Option (
		int count, const HC_KEY * keys, const char * type, char * value);
HC_EXTERNAL void HC_CDECL HC_PShow_One_Net_Heuristic (
		int count, const HC_KEY * keys, const char * type, char * value);
HC_EXTERNAL void HC_CDECL HC_PShow_One_Net_Rendering_Opti (
		int count, const HC_KEY * keys, const char * type, char * value);
#define HC_PShow_One_Net_Rendering_Option(count, keys, type, value) \
		HC_PShow_One_Net_Rendering_Opti(count, keys, type, value)
HC_EXTERNAL void HC_CDECL HC_PShow_One_Net_Selectability (
		int count, const HC_KEY * keys, const char * type, char * value);
HC_EXTERNAL void HC_CDECL HC_PShow_One_Net_Shader_Option (
		int count, const HC_KEY * keys, const char * name, const char * opt, char * output);
HC_EXTERNAL void HC_CDECL HC_PShow_One_Net_Text_Font (
		int count, const HC_KEY * keys, const char * type, char * value);
HC_EXTERNAL void HC_CDECL HC_PShow_One_Net_Texture (
		int count, const HC_KEY * keys, const char * txr, const char * opt, char * output);
HC_EXTERNAL void HC_CDECL HC_PShow_One_Net_Uni_Opt_Len (
...
HC_EXTERNAL void HC_CDECL HC_PShow_One_Net_Unicode_Opt (
...
HC_EXTERNAL void HC_CDECL HC_PShow_One_Net_User_Opt_Len (
...
HC_EXTERNAL void HC_CDECL HC_PShow_One_Net_User_Option (
		int count, const HC_KEY * keys, const char * type, char * value);
HC_EXTERNAL void HC_CDECL HC_PShow_One_Net_Visibility (
		int count, const HC_KEY * keys, const char * type, char * value);
...
HC_EXTERNAL void HC_CDECL HC_Read_Metafile (
...
HC_EXTERNAL HC_KEY HC_CDECL HC_Renumber_Key (
		HC_KEY old_key, HC_KEY new_key, const char * scope);
...
HC_EXTERNAL void HC_CDECL HC_Set_Color_By_Value (
		const char * types, const char * color_space, double a, double b, double c);
...
HC_EXTERNAL void HC_CDECL HC_Set_Geometry_Options (
		HC_KEY key, const char * options);
#define HC_Edit_Geometry_Options(key, options) \
		HC_Set_Geometry_Options(key, options)
...
HC_EXTERNAL void HC_CDECL HC_Show_Clip_Region (
		int * loops, int * lengths, HC_POINT * points, char * spec);
HC_EXTERNAL void HC_CDECL HC_Show_Clip_Region_Size (
		int * loops, int * total, char * spec);
...
HC_EXTERNAL void HC_CDECL HC_Show_Color_By_Value (
		char * type, char * color_space, float * a, float * b, float * c);
...
HC_EXTERNAL void HC_CDECL HC_Show_Cylinder (
		HC_KEY key, HC_POINT * point1, HC_POINT * point2, float * radius, char * cap);
...
HC_EXTERNAL HC_BOOLEAN HC_CDECL HC_Show_Error (
		char * severity, int * category, int * specific);
...
HC_EXTERNAL void HC_CDECL HC_Show_Geometry_Options (
		HC_KEY key, char * options);
HC_EXTERNAL void HC_CDECL HC_Show_Geometry_Pointer (
		HC_KEY key, const char * s, void * p);
...
HC_EXTERNAL int HC_CDECL HC_Show_Intersect_Polyline_Size (
		int point_count1, const HC_POINT * points1, int face_list_length1, const int * face_list1, int point_count2, const HC_POINT * points2, int face_list_length2, const int * face_list2, int * polyline_count, int * polyline_points_count);
...
HC_EXTERNAL void HC_CDECL HC_Show_NURBS_Surface (
		HC_KEY key, int * u_degree, int * v_degree, int * n_u_vertices, int * n_v_vertices, HC_POINT * control_points, float * weights, float * u_knots, float * v_knots);
HC_EXTERNAL void HC_CDECL HC_Show_NURBS_Surface_Size (
		HC_KEY key, int * u_degree, int * v_degree, int * n_u_vertices, int * n_v_vertices, int * weights_count, int * u_knots_count, int * v_knots_count);
HC_EXTERNAL HC_KEY HC_CDECL HC_Show_Named_Style (
		const char * style_name, char * style_segment_name);
...
HC_EXTERNAL void HC_CDECL HC_Show_One_Character_Attribute (
		HC_KEY key, int offset, const char * which, char * result);
...
HC_EXTERNAL void HC_CDECL HC_Show_One_Color_By_Value (
...
HC_EXTERNAL void HC_CDECL HC_Show_One_Uni_Option_Length (
		const unsigned short * uoname, int * length);
#define HC_Show_One_Unicode_Option_Length(uoname, length) \
		HC_Show_One_Uni_Option_Length(uoname, length)
...
HC_EXTERNAL void HC_CDECL HC_Show_Partial_Shell (
		HC_KEY key, int voffset, int vcount, HC_POINT * points, int foffset, int fcount, int * face_list_length, int * face_list);
HC_EXTERNAL void HC_CDECL HC_Show_Partial_Shell_Size (
		HC_KEY key, int foffset, int fcount, int * flist_length);
...
HC_EXTERNAL void HC_CDECL HC_Show_PolyCylinder (
		HC_KEY key, int * pcount, HC_POINT * pts, int * rcount, float * rads, char * listptr);
HC_EXTERNAL void HC_CDECL HC_Show_PolyCylinder_Counts (
		HC_KEY key, int * pcount, int * rcount, char * listptr);
...
HC_EXTERNAL void HC_CDECL HC_Show_Polyline_Count (
		HC_KEY key, int * count);
HC_EXTERNAL void HC_CDECL HC_Show_Priority (
		HC_KEY key, long * priority);
HC_EXTERNAL void HC_CDECL HC_Show_Priority_Range (
		HC_KEY key, long * low, long * high);
...
HC_EXTERNAL HC_KEY HC_CDECL HC_Show_Renumbered_Key (
		HC_KEY key, char * status);
HC_EXTERNAL void HC_CDECL HC_Show_Segment (
		HC_KEY key, char * pathname);
...
HC_EXTERNAL void HC_CDECL HC_Show_Selection_Pathname (
		char * segment);
HC_EXTERNAL void HC_CDECL HC_Show_Selection_Position (
...
HC_EXTERNAL void HC_CDECL HC_Show_Shell_Size (
		HC_KEY key, int * pcount, int * flist_lengthp);
...
HC_EXTERNAL void HC_CDECL HC_Show_Sphere (
		HC_KEY key, HC_POINT * center, float * radius, HC_POINT * axis, HC_POINT * ortho);
...
HC_EXTERNAL HC_KEY HC_CDECL HC_Show_Style_Segment (
		HC_KEY key, char * pathname);
HC_EXTERNAL void HC_CDECL HC_Show_System_Info (
		const char * type, char * value);
...
HC_EXTERNAL void HC_CDECL HC_Trim_NURBS_Surface_By_Curve (
		int degree, int control_point_count, const float * control_points, const float * weights, const float * knots, double start_u, double end_u);
HC_EXTERNAL void HC_CDECL HC_Trim_NURBS_Surface_By_Poly (
		int count, const float * points);
...
HC_EXTERNAL void HC_CDECL HC_UnDefine_Error_Handler (
		void (HC_CDECL * iroutine)(HC_ANY_ARGS));
...
HC_EXTERNAL HC_BOOLEAN HC_CDECL HC_Update_One_Display_Timed (
		const char * name, double limit);
HC_EXTERNAL void HC_CDECL HC_Write_Metafile (
		const char * segname, const char * file, const char * options);
