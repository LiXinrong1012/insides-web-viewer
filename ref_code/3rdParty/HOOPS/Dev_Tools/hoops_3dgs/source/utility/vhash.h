...
* manner of such use.
*
* $Id: vhash.h,v 1.99 2010-12-07 00:35:33 jason Exp $
*/
...
public:
	...
	PairList * GetPairList() {
		...
		return POOL_NEW(HOOPS_WORLD->memory_pool, PairList)(GetPairListInternal()); 
	}
#else
	PairList * GetPairList() {
...
public:
	...
	PairList * GetPairList() {
		...
		if (m_vhash->memory_pool)
			...
			pl = POOL_NEW(HOOPS_WORLD->memory_pool, PairList)(lv);
		return pl;
#else
		struct vlist_s *lv = new_vlist(vhash_malloc(m_vhash),vhash_free(m_vhash));
