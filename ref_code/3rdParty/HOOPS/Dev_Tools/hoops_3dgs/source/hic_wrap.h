 ...
 * manner of such use.
 *
 * $Id: hic_wrap.h,v 1.29 2010-11-09 23:36:09 boni Exp $
 */
...
public:
	...
	*/
	...
	virtual void draw_dc_phong_polyline(HIC_Rendition const *nr, int count, HIC_DC_Point const *points, HIC_RGBA const *colors, HIC_Plane const *planes)
	{
...
public:
	...
	*/
	...
	virtual void draw_dc_phong_polytriangle(HIC_Rendition const *nr, int count, HIC_DC_Point const *points, HIC_RGBA const *colors, HIC_Plane const *planes)
	{
...
public:
	...
	*/
	...
	virtual void draw_dc_textured_polyline(HIC_Rendition const *nr, int count, HIC_DC_Point const *points, HIC_RGBA const *colors, HIC_Plane const *planes, float const *parameters, int param_width, HIC_Integer32 param_flags)
	{
		HIC_Draw_DC_Textured_Polyline(nr, count, points, colors, planes, parameters, param_width, param_flags);
	}
...
public:
	...
	*/
	...
	virtual void draw_dc_textured_polytriangle(HIC_Rendition const *nr, int count, HIC_DC_Point const *points, HIC_RGBA const *colors, HIC_Plane const *planes, float const *parameters, int param_width, HIC_Integer32 param_flags)
	{
		HIC_Draw_DC_Textured_Polytriangle(nr, count, points, colors, planes, parameters, param_width, param_flags);
	}
...
/*!
The Set_Shader class is a base class used to define and set 
a callback at the "set shader" callback point during the HOOPS update 
cycle.  To use this class, derive your own child class from it and 
implement the method #set_shader. For more information on 
how to define and set callbacks as a C++/C/Java Developer, please see 
the <a href="../prog_guide/08_1_im_overview.html#8142_CallbacksForC++Developers">HOOPS/3dGS Programming Guide</a>.
*/
class HIC_API Set_Shader
{
public:
    ...
    */ 
	...
	/*!
        The function you implement for your callback.
        \param nr A pointer to a const HIC_Rendition
		\param driver_type A flag holding a HIC_Driver_Shader_Type bit
		\param geom_type A int flag holding a HIC_Driver_Shader_Geometry_Type bit
		\param geom_type A int flag holding a HIC_Driver_Shader_Geometry_Bits bit
        \param geometry A pointer to a const HIC_Geometry
	*/

	virtual void set_shader(HIC_Rendition const *nr, HIC_Driver_Shader_Type driver_type, HIC_Driver_Shader_Geometry_Type geom_type, HIC_Driver_Shader_Geometry_Bits geom_bits, long geometry)=0; //DNE
