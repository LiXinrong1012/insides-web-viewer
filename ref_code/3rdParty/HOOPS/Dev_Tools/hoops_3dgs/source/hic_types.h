 ...
 * manner of such use.
 *
 * $Id: hic_types.h,v 1.19 2010-07-21 02:25:07 covey Exp $
 */
...
typedef enum HIC_Attributes_e {
	...
	HIC_Attribute_SELECTABILITY			= 0x00000004,
	HIC_Attribute_VISIBILITY			= 0x00000008,
	HIC_Attribute_COLOR_MAP				= 0x00000010,
...
typedef enum HIC_Visibility_e {
	...
	HIC_Visibility_CUT_GEOMETRY			= 0x00000200,

	HIC_Visibility_LIGHTS_FOR_FACES		= 0x00000400,
	HIC_Visibility_LIGHTS_FOR_EDGES		= 0x00000800,
	HIC_Visibility_LIGHTS_FOR_MARKERS	= 0x00001000,

	HIC_Visibility_CUTTING_PLANES		= 0x00002000,
	...
	HIC_Visibility_ANY_SHADOW			= 0x00400000,
	...
	HIC_Visibility_LIGHTS				= HIC_Visibility_LIGHTS_FOR_FACES|HIC_Visibility_LIGHTS_FOR_EDGES|
											HIC_Visibility_LIGHTS_FOR_MARKERS,

	HIC_Visibility_GEOMETRY				= HIC_Visibility_FACES|HIC_Visibility_EDGES|HIC_Visibility_LINES|
											HIC_Visibility_MARKERS|HIC_Visibility_VERTICES|
											HIC_Visibility_IMAGES|HIC_Visibility_TEXT|
											HIC_Visibility_STRING_CURSORS|HIC_Visibility_LIGHTS
} HIC_Visibility;
...
typedef enum HIC_Color_Lock_Objects_e {	
	...
	HIC_Color_Lock_Objects_SIMPLE_REFLECTION=0x00000800,

	HIC_Color_Lock_Objects_FRONT_CONTRAST	=0x00001000,
	HIC_Color_Lock_Objects_BACK_CONTRAST	=0x00002000,
	HIC_Color_Lock_Objects_EDGE_CONTRAST	=0x00004000,
	HIC_Color_Lock_Objects_LINE_CONTRAST	=0x00008000,
	HIC_Color_Lock_Objects_VERTEX_CONTRAST	=0x00010000,
	HIC_Color_Lock_Objects_MARKER_CONTRAST	=0x00020000,
	HIC_Color_Lock_Objects_TEXT_CONTRAST	=0x00040000,
	HIC_Color_Lock_Objects_CUT_FACE_CONTRAST=0x00080000,
	HIC_Color_Lock_Objects_CUT_EDGE_CONTRAST=0x00100000,
	HIC_Color_Lock_Objects_WINDOW_CONTRAST	=0x00200000,

	HIC_Color_Lock_Objects_LIGHTING			=0x01000000,
	HIC_Color_Lock_Objects_AMBIENT_UP		=0x02000000,
	HIC_Color_Lock_Objects_AMBIENT_DOWN		=0x04000000,
	...
	HIC_Color_Lock_Objects_CONTRASTS		=(HIC_Color_Lock_Objects_FACE_CONTRAST|HIC_Color_Lock_Objects_EDGE_CONTRAST|
												...
												HIC_Color_Lock_Objects_WINDOW_CONTRAST),
...
typedef enum HIC_Geometry_Type_e {
	HIC_Geometry_Type_CUTTING_PLANE	= 37,		
...
typedef enum HIC_KInfo_Flags_e {	
	HIC_KInfo_Flags_NONE = 0
} HIC_KInfo_Flags;

typedef enum HIC_Shader_Type_e {
	HIC_Shader_Type_VERTEX_SHADER,
	HIC_Shader_Type_PIXEL_SHADER
} HIC_Shader_Type;

typedef enum HIC_Driver_Shader_Type_e {
	HIC_Driver_Shader_Type_DX9,
	HIC_Driver_Shader_Type_OGL2
} HIC_Driver_Shader_Type;

typedef enum HIC_Driver_Shader_Geometry_Type_e {
	HIC_Driver_Shader_Geometry_Type_FACES		= 0x00000001,
	HIC_Driver_Shader_Geometry_Type_EDGES		= 0x00000002,
	HIC_Driver_Shader_Geometry_Type_LINES		= 0x00000004,
	HIC_Driver_Shader_Geometry_Type_MARKERS		= 0x00000008,
	HIC_Driver_Shader_Geometry_Type_VERTICES	= 0x00000010,
	HIC_Driver_Shader_Geometry_Type_IMAGES		= 0x00000020
} HIC_Driver_Shader_Geometry_Type;

typedef enum HIC_Driver_Shader_Geometry_Bits_e {
	HIC_Driver_Shader_Geometry_Bits_VERTEX_INDICES			= 0x00000001,
	HIC_Driver_Shader_Geometry_Bits_FACE_INDICES			= 0x00000002,
	HIC_Driver_Shader_Geometry_Bits_VERTEX_COLORS			= 0x00000004,
	HIC_Driver_Shader_Geometry_Bits_VERTEX_FINDICES			= 0x00000008,
	HIC_Driver_Shader_Geometry_Bits_VERTEX_NORMALS			= 0x00000010,
	HIC_Driver_Shader_Geometry_Bits_VERTEX_PARAMS			= 0x00000020,
	HIC_Driver_Shader_Geometry_Bits_VERTEX_PARAM_WIDTH		= 0x00000040,
	HIC_Driver_Shader_Geometry_Bits_FACE_COLORS				= 0x00000080,
	HIC_Driver_Shader_Geometry_Bits_FACE_NORMALS			= 0x00000100,
	HIC_Driver_Shader_Geometry_Bits_INDEXED_TRISTRIP		= 0x00000200,
	HIC_Driver_Shader_Geometry_Bits_EDGE_NORMALS			= 0x00000400,
	HIC_Driver_Shader_Geometry_Bits_EDGE_COLORS				= 0x00000800
} HIC_Driver_Shader_Geometry_Bits;
