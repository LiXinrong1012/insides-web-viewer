/*
 * $Id: oglext.h,v 1.36 2010-06-02 05:54:43 heppe Exp $
 */
#ifndef __hoops_oglext_h_
#define __hoops_oglext_h_

/* rather than importing the standard extensions definitions wholesale (with
 * the resulting namespace pollution), define only the symbols we need, and
 * surround them with ifndef's to avoid duplicates. */
...
#ifndef DEPTH_TEXTURE_MODE_ARB
#	define	DEPTH_TEXTURE_MODE_ARB 0x884B
#endif
...
#undef GL_ELEMENT_BUFFER_ARB
# define GL_ELEMENT_BUFFER_ARB 0x8893
...
/* associated with the GL_ATI_meminfo extension */
