...
void BaseItemPosHelper::updateMarker( BaseItem* markerItem )
{
	...
	markerItem->set("R_RelativePos",osgMatrix2PosString(matrix));
	markerItem->set("R_RelativeX",osgMatrix2RelativeString(matrix,0));
	markerItem->set("R_RelativeY",osgMatrix2RelativeString(matrix,1));
	markerItem->set("R_RelativeZ",osgMatrix2RelativeString(matrix,2));
}
