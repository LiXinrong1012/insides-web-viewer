 ...
 *	If you donot want this notify Warning, you can set bWrn=false.
  */
class EDCORE_EXPORT ConsoleObserver
{
public:
    ConsoleObserver()
 ...
 *  @see ConsoleObserver
 */
class EDCORE_EXPORT ConsoleSingleton
{
 ...
 */  
class EDCORE_EXPORT ConsoleObserverFile : public ConsoleObserver
{
public:
 ...
 */
class EDCORE_EXPORT ConsoleObserverStd: public ConsoleObserver
{
public:
    ConsoleObserverStd();
...
class EDCORE_EXPORT RedirectStdOutput : public std::streambuf
{
public:
    RedirectStdOutput();
...
class EDCORE_EXPORT RedirectStdError : public std::streambuf
{
public:
    RedirectStdError();
...
class EDCORE_EXPORT RedirectStdLog : public std::streambuf
{
public:
    RedirectStdLog();
